...
Three historical artifacts failed byte hashes solely because Windows checkout
converted LF to CRLF. Converting only CRLF to LF reproduced the existing review
...
Exact-path Git attributes now pin text/eol=lf for these files. No global newline
