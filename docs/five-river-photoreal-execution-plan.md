...
- [ ] A1 South Fork American stationing and full-reach corridor repair.
  ...
  - [x] Execute the bounded official source pull for all six full-reach windows: `production_corridor/full_reach_windows/*/source/` now contains six USGS 3DEP 2048x2048 float TIFF DEM exports and six USDA NAIP 4096x4096 RGB PNG exports, with byte counts and SHA-256 hashes recorded in `production_corridor/full_reach_window_source_pull_status.json`; A1 remains blocked on six missing per-window manifests, stitched validation, and exact downstream-anchor review.
