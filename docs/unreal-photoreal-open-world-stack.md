...
The first generated preview maps are now available under `/Game/RaftSim/Maps/EnvironmentPreviews/`, and rendered guide-seat captures are written to `docs/environment-captures/photoreal_river_previews/` by the `RaftSim.CreatePhotorealEnvironmentPreviewMaps` and `RaftSim.CapturePhotorealEnvironmentPreviews` editor automation. South Fork, Colorado, and Pacuare now have source-draped preview overlays, source-drape terrain vertex-color blending, generated valley terrain, curved river ribbons, foam/hydraulic cue strips, first-party translucent water glints/foam flecks/haze/spray-mist layers, boulder bars, clustered foliage proxies, and per-river light/fog variants; the automation also scopes UE 5.8 startup-world GC leak checks to nonfatal during generated-map/capture batches so evidence capture can complete while diagnostics remain logged. The July 8 automated blocker-free pass adds deterministic atlas microtexture plus bounded water, canyon/bank, sky/depth, river-eye palette layers, and source-aware tapered water chroma microbreakup. The current automated review has zero blocker counts across all six guide-seat/river-eye captures, but this is not final photoreal approval: the screenshots still show proxy water marks, smooth procedural terrain, placeholder rocks/foliage, and review-only material instances. Final approval still requires full reviewed DEM/aerial imports plus rights-cleared or first-party production terrain, water, rock, foliage, foam/mist, lighting, and performance evidence.
