...
void CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_Func(float3 In_Position, float3 In_CurrUnit, float3 In_InPosition, float In_SimDt, float3 In_Velocity, bool In_Alive, float3 In_BubbleBounancy, float3 In_Gravity, float In_FoamThickness, float In_FoamAgingRate, float In_SprayAgingRate, float In_BubbleAgingRate, int In_State, float4x4 In_RiverUnitToWorld, float In_RiverAge, float3 In_RiverExtents, float3 In_RiverPhysicalExtents, out float3 Out_OutPosition, out float3 Out_OutVelocity, out bool Out_OutAlive, out int Out_OutState, out float Out_AgingRate, out float Out_OutSurfaceAge, out float Out_OutSurfacePhi)
{
	...
	float3 meta,dims;Get_User_RiverContactTriangles(0,meta);Get_User_RiverContactTriangles(1,dims);
	    int cols=(int)abs(dims.y),rows=(int)dims.z;
	    float2 xyMin=min(contactStart.xy,contactEnd.xy),xyMax=max(contactStart.xy,contactEnd.xy);
	    int c0=max(0,(int)floor((xyMin.x-meta.x)/meta.z)-1);
	    int c1=min(cols-1,(int)floor((xyMax.x-meta.x)/meta.z)+1);
	    int r0=max(0,(int)floor((meta.y-xyMax.y)/dims.x)-1);
	    int r1=min(rows-1,(int)floor((meta.y-xyMin.y)/dims.x)+1);
	    ...
	    for(int side=0;side<2 && !terrainHit;++side)
	    {
	        ...
	        if(dims.y<0)
	        {
	            ...
	            float2 quadOrigin=float2(meta.x+c*meta.z,meta.y-r*dims.x);
...
void Grid3D_Secondary_UpdateParticles_Emitter_Func(inout FSimulationContext Context)
{
	...
	float Constant122 = 1;
	float3 CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutPosition;
	float3 CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutVelocity;
	bool CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutAlive;
	int CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutState;
	float CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_AgingRate;
	float CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutSurfaceAge;
	float CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutSurfacePhi;
	CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_Func(Context.MapUpdate.Particles.Position, Result43, Context.MapUpdate.Particles.Position, Context.MapUpdate.Grid3D_Secondary_UpdateParticles.SimDt, Context.MapUpdate.Particles.Velocity, Context.MapUpdate.DataInstance.Alive, Constant93, Constant94, Constant95, Constant96, Constant97, Constant98, Context.MapUpdate.Particles.State, Context.MapUpdate.Emitter.UnitToWorld, Context.MapUpdate.Emitter.Age, Context.MapUpdate.User.WorldGridExtents, Context.MapUpdate.User.RiverSecondaryPhysicalExtents, CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutPosition, CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutVelocity, CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutAlive, CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutState, CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_AgingRate, CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutSurfaceAge, CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutSurfacePhi);
	Context.MapUpdate.Particles.Position = CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutPosition;
	Context.MapUpdate.Particles.Velocity = CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutVelocity;
	Context.MapUpdate.DataInstance.Alive = CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutAlive;
	Context.MapUpdate.Transient.AgingRate = CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_AgingRate;
	Context.MapUpdate.Particles.State = CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutState;
	Context.MapUpdate.Particles.RiverSurfaceAge = CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutSurfaceAge;
	Context.MapUpdate.Particles.RiverSurfacePhi = CustomHlslF7F7734BA29306DDC420D56B5A3248123318F446Emitter_SimGridReaderEmitter_BoundaryReaderUser_RiverSecondarySurfaceUser_RiverContactTrianglesUser_RiverCurrentSurfaceStage_FuncOutput_OutSurfacePhi;
	float Constant123 = 0;
