...
void Grid3D_Secondary_UpdateParticles_Emitter_Func(inout FSimulationContext Context)
{
	...
	float3 Constant101 = float3(0,0,-980);
	float Constant102 = 1;
	float3 CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_OutPosition;
	float3 CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_OutVelocity;
	bool CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_OutAlive;
	int CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_OutState;
	float CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_AgingRate;
	CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_Func(Context.MapUpdate.Particles.Position, Result43, Context.MapUpdate.Particles.Position, Context.MapUpdate.Grid3D_Secondary_UpdateParticles.SimDt, Context.MapUpdate.Particles.Velocity, Context.MapUpdate.DataInstance.Alive, Constant91, Constant92, Constant93, Constant94, Constant95, Constant96, Context.MapUpdate.Particles.State, Context.MapUpdate.Emitter.UnitToWorld, CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_OutPosition, CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_OutVelocity, CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_OutAlive, CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_OutState, CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_AgingRate);
	Context.MapUpdate.Particles.Position = CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_OutPosition;
	Context.MapUpdate.Particles.Velocity = CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_OutVelocity;
	Context.MapUpdate.DataInstance.Alive = CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_OutAlive;
	Context.MapUpdate.Transient.AgingRate = CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_AgingRate;
	Context.MapUpdate.Particles.State = CustomHlslBDA78C12557E87D83D7E48C0986B43E4112DDAC8Emitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_FuncOutput_OutState;
	float Constant103 = 0;
	bool CustomHlsl0043978A94D5ECC735E88B74DA7024FE055B8BB4A9A_FuncOutput_IsInside;
	CustomHlsl0043978A94D5ECC735E88B74DA7024FE055B8BB4A9A_Func(Constant103, CustomHlsl0043978A94D5ECC735E88B74DA7024FE055B8BB4A9A_FuncOutput_IsInside);
...
void ParticleState_Emitter_Func(inout FSimulationContext Context)
{
	...
	float Result47 = max(Context.MapUpdate.ParticleState.Lifetime, Constant114);
	float Constant115 = 0.0001;
	float Result48 = Result47 - Constant115;
...
void Grid3D_Secondary_EmissionPoints_Emitter_Func(inout FSimulationContext Context)
{
	...
	float Constant146 = 1;
	float Constant147 = 5;
	float Constant148 = 20;
	float Constant149 = 0;
	float Constant150 = 0;
	float Constant151 = 1;
	float Constant152 = 0;
	float2 Constant153 = float2(0,1e+06);
	float Constant154 = -1e+06;
	...
	float Constant159 = 1;
	float Result53 = rand_float(Constant159);
	float Constant160 = 0;
	float Constant161 = 1;
	float Constant162 = 5;
	float Constant163 = 20;
	float Constant164 = 0;
	float Constant165 = 0;
	float Constant166 = 1;
	float Constant167 = 0;
	float2 Constant168 = float2(0,1e+06);
	float Constant169 = -1e+06;
	...
	float Constant179 = 1;
	float Constant180 = 0;
	float2 Constant181 = float2(0,1e+06);
	...
	float Constant187 = 1;
	float Constant188 = 5;
	float Constant189 = 20;
	float Constant190 = 0;
	float Constant191 = 0;
	float Constant192 = 1;
	float Constant193 = 0;
	float2 Constant194 = float2(0,1e+06);
	float Constant195 = -1e+06;
	float Constant196 = 0.0001;
	float Constant197 = 0;
	float Constant198 = 0;
	float Constant199 = 0;
	float Constant200 = 1;
	float Constant201 = 5;
	float Constant202 = 20;
	float Constant203 = 0;
	float Constant204 = 0;
	float Constant205 = 1;
	float Constant206 = 0;
	float2 Constant207 = float2(0,1e+06);
	float Constant208 = -1e+06;
	float Constant209 = 0.0001;
	float Constant210 = 0;
	float Constant211 = 0;
	float Constant212 = 0;
	CustomHlslBAE80D59167527A315F3E946C5C1CA93D6E9B2B0Emitter_EmissionCounterEmitter_EmissionPositionsEmitter_SimGridReaderEmitter_SDFReaderEmitter_BoundaryReader_Func(ExecutionIndexToGridIndex_Emitter_SimGridReaderOutput_IndexX, ExecutionIndexToGridIndex_Emitter_SimGridReaderOutput_IndexY, ExecutionIndexToGridIndex_Emitter_SimGridReaderOutput_IndexZ, Context.MapSimStage1_FindSecondaryEmissionPoints.Grid3D_Secondary_EmissionPoints.SimDt, Constant133, Result51, Constant134, Constant135, Context.MapSimStage1_FindSecondaryEmissionPoints.Grid3D_Secondary_EmissionPoints.MaxSecondaryParticlesPerFrame, ExecutionIndexToUnit_Emitter_SimGridReaderOutput_Unit, SamplePreviousGridFloatValue_Emitter_SDFReader_AttributeSDFOutput_Value, Constant136, Constant137, Result52, Constant138, Constant139, Result53, Constant140, Constant141, Constant142, Constant160, Constant143, Constant144, Constant145, Context.MapSimStage1_FindSecondaryEmissionPoints.User.WorldGridExtents, Context);
}
