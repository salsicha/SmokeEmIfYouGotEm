...
- These captures verify editor automation, guide-seat and raft-hidden river-eye camera paths, generated valley terrain meshes, terrain-conforming source drapes, lit preview materials, curved river ribbons, subtle current-streak proxies, procedural foam/wave/eddy-line ribbons, boulder bars, PCG sample foliage and bank understory/scrub placeholders, and per-river light/fog variants. They must be replaced by source-derived or rights-cleared photoreal passes before the goal is complete.
