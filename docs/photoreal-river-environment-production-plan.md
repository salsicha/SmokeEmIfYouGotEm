...
- The preview generator now keeps source provenance out of the rendered guide-seat frame and records it in JSON instead. Foliage proxies use rounded clustered canopies and slimmer trunks rather than cone silhouettes, which improves review readability but is still not production photoreal vegetation.
