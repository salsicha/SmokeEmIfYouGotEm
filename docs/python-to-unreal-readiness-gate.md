...
- `geoclaw_cpp_comparison_summary.json`: 28 of 40 GeoClaw/C++ threshold comparisons pass, so the comparison gate blocks.
...
- Preserve the reduced eddy-line/shear closure as a guardrail while the finite-volume eddy-line row and broader shallow-shelf, real-world, reduced cascading, and raft-coupling failures remain visible.
