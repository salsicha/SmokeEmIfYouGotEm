...
- `geoclaw_cpp_comparison_summary.json`: 26 of 40 GeoClaw/C++ threshold comparisons pass, so the comparison gate blocks.
...
- Preserve the reduced lateral-wave closure as a guardrail while the finite-volume lateral-wave row and broader rapid-feature, real-world, reduced cascading, and raft-coupling failures remain visible.
