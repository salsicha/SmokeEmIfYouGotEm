...
- `geoclaw_cpp_comparison_summary.json`: 30 of 40 GeoClaw/C++ threshold comparisons pass, so the comparison gate blocks.
...
- Preserve both lateral-wave closures as guardrails while broader eddy-line, shallow-shelf, real-world, reduced cascading, and raft-coupling failures remain visible.
- Preserve both eddy-line/shear closures as guardrails while broader shallow-shelf, real-world, reduced cascading, and raft-coupling failures remain visible.
- Preserve the reduced shallow-shelf closure as a guardrail while the finite-volume shallow-shelf row and broader real-world, reduced cascading, and raft-coupling failures remain visible.
