...
The detailed implementation and validation sequence is now `docs/named-rapid-realism-validation-plan.md`. The source catalog records 85 review markers across five runnable rivers plus Zambezi as one additional active environment. Generated Unreal manifests expose those markers, 50 non-authoritative candidate map points, and 453 low/reference/high-flow simulator run definitions in the Rapid/River Editor. Published South Fork miles are retained, Colorado miles remain cross-check gated, and Pacuare/Zambezi/Futaleufu/Chilko markers are visibly provisional until GPS/aerial/guide stationing replaces them. Chilko contributes Bidwell Rapids, Lava Canyon, White Mile, Green Mile, and Miracle Canyon leads; Zambezi retains all existing evidence without being counted as runnable. No run is considered executed or validated until exact geometry, an accepted C++ water window, and a guide-reviewed line are bound and telemetry/video evidence passes.
