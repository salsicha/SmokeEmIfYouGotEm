# Historical README — before project normalization

Archived on 2026-09-06. These are historical progress claims, not the current acceptance state. See the [current README](../../README.md) and [South Fork plan](../plans/south-fork-evidence-reconstruction.md).
