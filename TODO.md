...
- [ ] Finish bed-step parity with an augmented topography Riemann/source-distribution fix that passes `field_linf` and `slope_linf` together without widening thresholds, adding feature forcing, or regressing raft-coupling promotions.
