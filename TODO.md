...
- [ ] Decide whether reduced-mode bed-step parity should be redesigned or explicitly scoped out of strict discontinuous-bed parity; it remains blocked on field, slope, probe, mass-drift, and energy checks.
