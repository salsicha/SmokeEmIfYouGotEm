...
const FWaterNiagaraProfile WaterProfiles[] = {
    ...
    },
    {
        ...
        320.0f,
        FVector2f(0.50f, 0.96f),
        FVector2f(12.0f, 18.0f),
        FVector2f(40.0f, 70.0f),
        FVector2f(240.0f, 70.0f),
        FVector2f(140.0f, 320.0f),
        38.0f,
        FVector3f(0.0f, 0.0f, -260.0f),
        0.55f,
        FLinearColor(0.92f, 0.96f, 0.98f, 0.78f),
        true,
        0,
        10,
    },
    {
        ...
        300.0f,
        FVector2f(0.36f, 0.78f),
        FVector2f(4.0f, 7.0f),
        FVector2f(16.0f, 30.0f),
        FVector2f(120.0f, 36.0f),
        FVector2f(320.0f, 650.0f),
        34.0f,
        FVector3f(0.0f, 0.0f, -980.0f),
        0.22f,
        FLinearColor(0.90f, 0.96f, 1.00f, 0.88f),
        true,
        0,
        10,
    },
