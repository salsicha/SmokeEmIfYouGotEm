    ...
    FString& OutSummary)
{
    ...
    {
        OutSummary += TEXT(
            "Failed to create Pacuare Upper Huacas live-water textures.\n");
        return nullptr;
    }
    ...
    {
        OutSummary += TEXT(
            "Pacuare live-water parent or river-local texture is missing.\n");
        return nullptr;
    }
    ...
    {
        OutSummary += TEXT(
            "Failed to create the Pacuare live-water material instance.\n");
        return nullptr;
    }
    ...
    {
        OutSummary += TEXT(
            "Failed to save the Pacuare live-water material instance.\n");
        return nullptr;
    }
    OutSummary += TEXT(
        "Built Pacuare Upper Huacas live-volume water V1 with first-party "
