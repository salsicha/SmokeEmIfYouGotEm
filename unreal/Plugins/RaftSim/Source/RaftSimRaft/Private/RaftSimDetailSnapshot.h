...
struct FRaftSimDetailSnapshot
{
    ...
    FString Prefix;
    double Elapsed=0,SimulationSeconds=0;
    ...
    bool Poll()
    {
        ...
        const bool bArrays=Save(TEXT(".flow.f32"),Flow) && Save(TEXT(".state.f32"),State) && Save(TEXT(".surface.f32"),Surface);
        ...
        const bool bMetadata=FFileHelper::SaveStringToFile(Metadata,*(Prefix+TEXT(".json")));
