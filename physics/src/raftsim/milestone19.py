    ...
    *,
    ...
    for index, fixture in enumerate(fixtures):
        ...
        manifest_entry = {
            ...
            "duration_seconds": step_count * fixed_step_seconds,
...
def _build_replay_summary(
    *,
    ...
    return {
        "schema": CHAOS_REPLAY_SUMMARY_SCHEMA,
        "runtime_id": CHAOS_RUNTIME_ID,
        "fixture_id": fixture["fixture_id"],
        "source_contract": source_contract_path,
        ...
        "replay_reproduction": {
            "full_telemetry_stream": (
                f"Saved/Automation/RaftSim/Chaos/{fixture['fixture_id']}.telemetry.jsonl"
            ),
            "determinism_hash_scope": "gameplay-state telemetry, contacts, raft pose, and fixture inputs",
            "replace_placeholder_frames_after_unreal_run": True,
        },
    }
...
def _schema_sample_frame(
    *,
    ...
    return {
        ...
        "outcome": outcome,
        "runtime_cpu_ms": 0.0,
        "determinism_hash": _determinism_hash(fixture_id, step_index, parameter_case),
    }
...
def _determinism_hash(fixture_id: str, step_index: int, parameter_case: dict[str, Any]) -> str:
    payload = json.dumps(
        {
            "runtime": CHAOS_RUNTIME_ID,
            "fixture": fixture_id,
...
def _summary_markdown(summary: dict[str, Any]) -> str:
    lines = [
        ...
        "",
        (
            f"Exported {summary['fixture_count']} Chaos fixtures with "
