"""Generate the Troublemaker reach-local C3 water-window scenario packages.
...
def main() -> None:
    ...
    work_dir = args.work_dir or (repo_root / "physics/outputs/troublemaker_c3_window")
    report = run_troublemaker_behavioral_validation(
        repo_root,
