"""Generate the Milestone 18 constriction lateral face-flux diagnostic."""
...
from ..milestone18 import build_milestone18_constriction_lateral_face_flux_report
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--output-json",
        type=Path,
        default=Path("reports/milestone18/constriction_lateral_face_flux_diagnostic.json"),
    )
    parser.add_argument(
        "--output-md",
        type=Path,
        default=Path("reports/milestone18/constriction_lateral_face_flux_diagnostic.md"),
    )
    args = parser.parse_args(argv)

    report = build_milestone18_constriction_lateral_face_flux_report(
    ...
    print(f"constriction_lateral_face_flux_report={json_path}")
