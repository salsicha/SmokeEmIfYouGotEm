"""Generate the Milestone 18 constriction shape/timing diagnostic."""
...
from ..milestone18 import build_milestone18_constriction_shape_timing_report
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--output-json",
        type=Path,
        default=Path("reports/milestone18/constriction_shape_timing_diagnostic.json"),
    )
    parser.add_argument(
        "--output-md",
        type=Path,
        default=Path("reports/milestone18/constriction_shape_timing_diagnostic.md"),
    )
    args = parser.parse_args(argv)

    report = build_milestone18_constriction_shape_timing_report(
    ...
    print(f"constriction_shape_timing_report={json_path}")
