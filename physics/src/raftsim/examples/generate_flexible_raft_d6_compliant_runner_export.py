"""Generate the fail-closed D6 compliant-reference runner export bundle."""
...
from raftsim.flexible_raft_d6_compliant_runner_export import (
    ...
    write_flexible_raft_d6_compliant_runner_export,
    write_flexible_raft_d6_compliant_runner_sidecar_payload,
    write_flexible_raft_d6_compliant_runner_summary_payload,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.sidecar_output is None and args.summary_output is None:
        ...
        summary_path = args.summary_output or (
            args.repo_root / "physics/reports/d6/compliant/summary.json"
        )
        write_flexible_raft_d6_compliant_runner_sidecar_payload(
            sidecar_path,
            sidecar,
    ...
    print(f"compliant_runner_sidecar={sidecar_path}")
    print(f"compliant_runner_summary={summary_path}")
