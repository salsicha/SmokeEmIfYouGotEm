"""Generate the B2 import/capture review sidecar template and merge report."""
...
def main() -> None:
    ...
    paths = [
        write_b2_import_capture_review_sidecar_template(repo_root),
        write_b2_import_capture_review_sidecar_merge_report(repo_root),
    ]
    report = build_b2_import_capture_review_sidecar_merge_report()
    for path in paths:
