...
def _cpp_config_for_mode(
    ...
    *,
    ...
    if not finite_volume and gate_scenario_id == "shallow_shelf":
        preserve_initial_mass = False
    if not finite_volume and gate_scenario_id == "south_fork_low_runnable":
        preserve_initial_mass = False
    if not finite_volume and gate_scenario_id == "south_fork_median_runnable":
        preserve_initial_mass = False
    ...
    if not finite_volume and gate_scenario_id == "south_fork_cascading_low_runnable":
        preserve_initial_mass = False
    if not finite_volume and gate_scenario_id == "south_fork_cascading_median_runnable":
        preserve_initial_mass = False
    if not finite_volume and gate_scenario_id == "south_fork_cascading_high_runnable":
        preserve_initial_mass = False
