...
{arrays}
    ...
    {{
        ...
        float full = Cover(RankMixFull({WEIGHTS_FULL[0]} * coarse + {WEIGHTS_FULL[1]} * fine +
            {WEIGHTS_FULL[2]} * clump + {WEIGHTS_FULL[3]} * grain), p);
        float noGrain = Cover(RankMixNoGrain({WEIGHTS_NO_GRAIN[0]} * coarse + {WEIGHTS_NO_GRAIN[1]} * fine +
            {WEIGHTS_NO_GRAIN[2]} * clump), p);
        float coarseOnly = Cover(RankMixCoarse({WEIGHTS_COARSE[0]} * coarse + {WEIGHTS_COARSE[2]} * clump), p);
