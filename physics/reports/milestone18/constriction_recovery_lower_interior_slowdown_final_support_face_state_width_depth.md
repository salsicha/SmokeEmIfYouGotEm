...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_recovery_lower_interior_slowdown_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_recovery_lower_interior_slowdown_final_support/finite_volume_roe/scenario/constriction_seed_16`
...
| `upper_edge_face` | 8 | `7-8` | `upstream_approach` | `1.85053/-0.760508/-1.40735/-1` | `1.63997/-1.18693/-1.94653/-1` | -0.539187 | -0.210563 | `0/0/0` | `face=True, width=False, bank=False, depth=False` | `geometry_aware_face_state_reconstruction` |
| `lower_edge_face` | 2 | `1-2` | `upstream_approach` | `1.01111/1.30241/1.31687/1` | `1.0806/1.53719/1.66108/1` | 0.344202 | 0.0694885 | `0/0/0` | `face=True, width=False, bank=False, depth=False` | `geometry_aware_face_state_reconstruction` |
...
| `upper_edge_face` | 9 | `7-8` | `upstream_approach` | `0.983374/-1.39145/-1.36832/-1` | `1.40762/-1.18447/-1.66728/-1` | -0.298964 | 0.424249 | `0/0/0` | `face=True, width=False, bank=False, depth=False` | `geometry_aware_face_state_reconstruction` |
| `upper_edge_face` | 6 | `8-9` | `upstream_approach` | `1.15452/-1.44608/-1.66953/-1` | `1.23286/-1.11999/-1.38079/-1` | 0.288741 | 0.0783373 | `1/0/0` | `face=True, width=False, bank=False, depth=False` | `geometry_aware_face_state_reconstruction` |
...
| `lower_edge_face` | 1 | `1-2` | `upstream_approach` | `0.978339/2.01871/1.97499/1` | `1.05713/1.72774/1.82644/1` | -0.148545 | 0.0787885 | `0/0/0` | `face=False, width=False, bank=False, depth=False` | `preserve_as_guardrail` |
...
| 3 | `upstream_approach` | `8/2-9/1.25` | `11/1-11/1.26074` | `11/1-11/1.23628` | `0/0/0/-0.0244649` | `width=False, bank=False, depth=False` |
