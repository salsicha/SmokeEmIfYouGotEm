...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_upstream_lower_edge_inner_cross_stream_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_upstream_lower_edge_inner_cross_stream_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.466735`
- Max h/u/v/hu/hv delta: `0.355242` / `0.439552` / `0.402237` / `0.465123` / `0.466735`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `upstream_approach` | `interior` | 54 | -0.0472677 / 0.263487 | 0.0304297 / 0.26848 | -0.0294245 / 0.259132 | 0.0336465 / 0.465123 | -0.0575609 / 0.466735 | -2.55245 | 0 | 1.86694 |
...
- Final-frame `hv` field remains 1.87x over threshold at `upstream_approach/interior` cell 7,6.
...
- Cross-stream shear/momentum mismatch is still active in `upstream_approach/interior` (max v/hv delta `0.259132`/`0.466735`).

## Next Levers

- Start with `upstream_approach/interior` cell 7,6; `hv` delta is `0.466735` with reference h `1.81422` m and C++ h `1.81335` m.
