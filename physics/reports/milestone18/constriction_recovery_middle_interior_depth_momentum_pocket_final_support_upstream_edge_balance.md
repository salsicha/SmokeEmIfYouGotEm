...
Face-state width/depth report: `physics/reports/milestone18/constriction_recovery_middle_interior_depth_momentum_pocket_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_recovery_middle_interior_depth_momentum_pocket_final_support_face_source_audit.json`
...
| --- | ---: | --- | --- | --- | ---: | ---: | --- | --- | ---: | --- |
| `lower_edge_face` | 6 | `1-2` | `0.728892/1` | `0.656855/1` | -0.0720362 | -9.58436 | `width=1, bank=0, face_h=-0.301868, column_h=-0.221841` | `2.39879/1` | 1.6699 | `upstream_edge_width_depth_flux_balance` |
| `upper_edge_face` | 6 | `8-9` | `-1.66953/-1` | `-1.60319/-1` | 0.0663386 | -0.4596 | `width=1, bank=0, face_h=-0.029509, column_h=-0.221841` | `-1.6745/-1` | -0.00496879 | `upstream_edge_width_depth_mapping` |
...
| `lower_edge_face` | 2 | `1-2` | `1.31687/1` | `1.58673/1` | 0.26986 | 1.35213 | `width=0, bank=0, face_h=0.0211954, column_h=0.00123228` | `2.4671/1` | 1.15023 | `upstream_edge_y_face_flux_source_balance` |
| `upper_edge_face` | 3 | `8-9` | `-1.36827/-1` | `-1.4964/-1` | -0.128122 | 1.30198 | `width=0, bank=0, face_h=0.102397, column_h=-0.0145922` | `-2.88527/-1` | -1.51699 | `upstream_edge_y_face_flux_source_balance` |
| `lower_edge_face` | 0 | `1-2` | `2.04571/1` | `1.96812/1` | -0.0775862 | -1.43478 | `width=0, bank=0, face_h=-0.0414057, column_h=-0.051425` | `3.41704/1` | 1.37133 | `upstream_edge_y_face_flux_source_balance` |
| `lower_edge_face` | 3 | `1-2` | `0.823895/1` | `0.777702/1` | -0.0461928 | -2.17379 | `width=0, bank=0, face_h=-0.0722688, column_h=-0.0145922` | `2.13313/1` | 1.30924 | `upstream_edge_y_face_flux_source_balance` |
...
| `lower_edge_face` | 1 | `1-2` | `1.97499/1` | `1.70864/1` | -0.266343 | -0.725911 | `width=0, bank=0, face_h=0.0105487, column_h=-0.0242574` | `2.32567/1` | 0.35068 | `geometry_aware_face_state_reconstruction` |
