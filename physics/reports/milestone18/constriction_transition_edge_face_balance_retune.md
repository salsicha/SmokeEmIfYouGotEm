...
| --- | --- | --- | --- | --- |
| `finite_volume_roe` | `roe_transition_edge_face_balance` | BLOCKED | field_linf, slope_linf, wet_mismatch_fraction, probe_linf, cross_section_linf, froude_delta | `bed_slope_source_scale=0.75, boundary_mode=scenario, cfl=0.45, dry_tolerance=1e-06, feature_strength_scale=0, flux_scheme=roe, preserve_initial_mass=False, roughness_scale=0.5, solver_mode=finite_volume` |
...
| --- | ---: | ---: | --- |
| `field_linf` | 3.47192 | 0.25 | FAIL |
| `slope_linf` | 0.811032 | 0.25 | FAIL |
| `wet_mismatch_fraction` | 0.270833 | 0.02 | FAIL |
| `probe_linf` | 2.15656 | 0.25 | FAIL |
| `cross_section_linf` | 1.6623 | 0.25 | FAIL |
| `mass_drift_delta` | 0.048348 | 0.05 | PASS |
| `energy_change_delta` | 0.149531 | 0.25 | PASS |
| `froude_delta` | 1.22543 | 0.5 | FAIL |
| `feature_location_delta` | 3.60555 | 5 | PASS |
| `feature_strength_delta` | 0.770133 | 10 | PASS |

## Notes

- Extend constriction y-face state/source treatment into the transition edge window; feature forcing remains off.
- Do not promote: target transition upper-edge post-source sign is repaired, but field, slope, wet-mask, probe, cross-section, and Froude parity remain blocked.
