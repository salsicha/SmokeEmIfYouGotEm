...
- Max field delta: `0.654883`
- Max h/u/v/hu/hv delta: `0.466456` / `0.654883` / `0.651338` / `0.622135` / `0.652559`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `recovery` | `upper_edge` | 8 | 0.113578 / 0.355242 | -0.0922976 / 0.654883 | 0.111401 / 0.585144 | 0.0116948 / 0.144237 | -0.0630513 / 0.164374 | 0.908621 | 0 | 2.61953 |
...
- Final-frame `u` field remains 2.62x over threshold at `recovery/upper_edge` cell 9,22.
...
- Start with `recovery/upper_edge` cell 9,22; `u` delta is `-0.654883` with reference h `0.260593` m and C++ h `0.375` m.
