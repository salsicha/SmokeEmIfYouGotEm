...
Face-state width/depth report: `physics/reports/milestone18/constriction_upstream_upper_edge_shelf_momentum_pocket_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_upstream_upper_edge_shelf_momentum_pocket_final_support_face_source_audit.json`
...
- Max abs balance delta: `9.18497` m3/s2
...
| --- | ---: | --- | --- | --- | ---: | ---: | --- | --- | ---: | --- |
| `lower_edge_face` | 5 | `1-2` | `1.46296/1` | `0.903336/1` | -0.559621 | -9.18497 | `width=0, bank=0, face_h=-0.272206, column_h=-0.0905715` | `1.86254/1` | 0.39958 | `upstream_edge_width_depth_flux_balance` |
...
| `lower_edge_face` | 4 | `1-2` | `0.236126/1` | `0.576102/1` | 0.339976 | -5.0306 | `width=0, bank=0, face_h=-0.1769, column_h=-0.0630068` | `2.00116/1` | 1.76504 | `upstream_edge_y_face_flux_source_balance` |
...
- Start with `lower_edge_face` column 5 rows 1-2; q delta is -0.559621 m3/s, balance delta is -9.18497 m3/s2, native post-source delta is 0.39958 m3/s, wet-width delta is 0 cells, and bank-row delta is 0 cells.
