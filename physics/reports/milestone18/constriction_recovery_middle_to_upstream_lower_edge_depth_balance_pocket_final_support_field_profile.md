...
- Max field delta: `0.312878`
- Max h/u/v/hu/hv delta: `0.293742` / `0.291581` / `0.300528` / `0.309443` / `0.312878`
...
- Final-frame `hv` field remains 1.25x over threshold at `constriction_throat/lower_edge` cell 4,12.
...
- Start with `constriction_throat/lower_edge` cell 4,12; `hv` delta is `0.312878` with reference h `1.47238` m and C++ h `1.53674` m.
