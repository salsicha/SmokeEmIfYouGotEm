...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_upstream_outer_lower_shelf_streamwise_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_upstream_outer_lower_shelf_streamwise_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.777015`
- Max h/u/v/hu/hv delta: `0.655706` / `0.777015` / `0.770026` / `0.76214` / `0.741659`
...
- Final-frame `u` field remains 3.11x over threshold at `downstream_constriction/interior` cell 5,14.
- Depth/profile mismatch is still active in `recovery/upper_edge` (max h delta `0.655706` m).
- Streamwise shear/momentum mismatch is still active in `downstream_constriction/interior` (max u/hu delta `0.777015`/`0.600363`).
