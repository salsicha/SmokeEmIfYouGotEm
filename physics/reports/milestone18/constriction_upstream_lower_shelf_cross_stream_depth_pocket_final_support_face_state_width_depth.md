...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_upstream_lower_shelf_cross_stream_depth_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_upstream_lower_shelf_cross_stream_depth_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
...
- Max abs volume-flux delta: `0.706291` m3/s
- Max abs face mean-depth delta: `0.424249` m
...
| --- | ---: | --- | --- | --- | --- | ---: | ---: | --- | --- | --- |
| `lower_edge_face` | 5 | `1-2` | `upstream_approach` | `1.24635/1.17379/1.46296/1` | `0.974149/0.776746/0.756666/1` | -0.706291 | -0.272206 | `0/0/0` | `face=True, width=False, bank=False, depth=False` | `geometry_aware_face_state_reconstruction` |
...
| `lower_edge_face` | 4 | `1-2` | `upstream_approach` | `1.15499/0.20444/0.236126/1` | `0.978093/0.588889/0.575988/1` | 0.339862 | -0.1769 | `0/0/0` | `face=True, width=False, bank=False, depth=False` | `geometry_aware_face_state_reconstruction` |
...
| `lower_edge_face` | 0 | `1-2` | `upstream_approach` | `1.198/1.70761/2.04571/1` | `1.15659/1.5076/1.74367/1` | -0.302035 | -0.0414057 | `0/0/0` | `face=True, width=False, bank=False, depth=False` | `geometry_aware_face_state_reconstruction` |
...
| `lower_edge_face` | 6 | `1-2` | `upstream_approach` | `1.39221/0.523551/0.728892/1` | `1.09034/0.443958/0.484066/1` | -0.244826 | -0.301868 | `1/0/0` | `face=True, width=False, bank=False, depth=False` | `geometry_aware_face_state_reconstruction` |
