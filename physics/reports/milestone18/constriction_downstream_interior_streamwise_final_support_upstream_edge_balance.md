...
Face-state width/depth report: `physics/reports/milestone18/constriction_downstream_interior_streamwise_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_downstream_interior_streamwise_final_support_face_source_audit.json`
...
| `upper_edge_face` | 1 | `8-9` | `-2.29862/-1` | `-1.87455/-1` | 0.424073 | -1.60681 | `width=0, bank=0, face_h=0.0138652, column_h=-0.0256694` | `-2.98848/-1` | -0.689863 | `upstream_edge_y_face_flux_source_balance` |
