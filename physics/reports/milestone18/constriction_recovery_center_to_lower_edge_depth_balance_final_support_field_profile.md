...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_recovery_center_to_lower_edge_depth_balance_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_recovery_center_to_lower_edge_depth_balance_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.270925`
- Max h/u/v/hu/hv delta: `0.270925` / `0.265283` / `0.263705` / `0.266907` / `0.258701`
- Max profile mass delta: `3.62303` m3
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `recovery` | `interior` | 46 | 0.0787615 / 0.270925 | -0.064778 / 0.265283 | -0.00509798 / 0.189581 | 0.0587938 / 0.266907 | 0.000828235 / 0.226973 | 3.62303 | 0 | 1.0837 |
...
- Final-frame `h` field remains 1.08x over threshold at `recovery/interior` cell 3,19.
...
- Start with `recovery/interior` cell 3,19; `h` delta is `0.270925` with reference h `1.16739` m and C++ h `1.43831` m.
