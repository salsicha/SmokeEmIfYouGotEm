...
- Start with `lower_edge_face` column 5 rows 1-2; q delta is -0.29451 m3/s, face mean-depth delta is -0.163673 m, wet-width delta is 0 cells, and max bank-row delta is 0 cells.
