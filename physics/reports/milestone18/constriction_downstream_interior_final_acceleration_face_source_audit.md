...
| `lower_inner_source_face` | 14 | `3-4` | `1.15525/1` | -1.5422 | `-1.5422/-1` | -2.69745 | `False` | `False` | `False` | `False` | `0.0397685/-0` |
| `upper_outer_face` | 7 | `8-9` | `-1.31978/-1` | 1.35659 | `1.35657/1` | 2.67635 | `False` | `False` | `True` | `True` | `-12.4163/-1.63642` |
| `lower_inner_source_face` | 15 | `3-4` | `1.15902/1` | -1.5045 | `-1.5045/-1` | -2.66352 | `False` | `False` | `False` | `False` | `0.0397685/-0` |
