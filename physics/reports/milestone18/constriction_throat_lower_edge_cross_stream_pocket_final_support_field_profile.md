...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_throat_lower_edge_cross_stream_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_throat_lower_edge_cross_stream_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.439552`
- Max h/u/v/hu/hv delta: `0.355242` / `0.439552` / `0.402237` / `0.436356` / `0.412687`
...
- Final-frame `u` field remains 1.76x over threshold at `recovery/interior` cell 3,17.
...
- Start with `recovery/interior` cell 3,17; `u` delta is `0.439552` with reference h `0.578351` m and C++ h `0.575` m.
