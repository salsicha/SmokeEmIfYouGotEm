...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_upstream_upper_edge_shelf_mid_streamwise_velocity_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_upstream_upper_edge_shelf_mid_streamwise_velocity_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.388646`
- Max h/u/v/hu/hv delta: `0.355242` / `0.353905` / `0.33579` / `0.388646` / `0.386887`
...
- Final-frame `hu` field remains 1.55x over threshold at `upstream_approach/interior` cell 6,3.
- Depth/profile mismatch is still active in `recovery/upper_edge` (max h delta `0.355242` m).
- Streamwise shear/momentum mismatch is still active in `upstream_approach/interior` (max u/hu delta `0.254233`/`0.388646`).
- Cross-stream shear/momentum mismatch is still active in `upstream_approach/interior` (max v/hv delta `0.220581`/`0.386887`).

## Next Levers

- Start with `upstream_approach/interior` cell 6,3; `hu` delta is `0.388646` with reference h `1.80005` m and C++ h `1.83684` m.
