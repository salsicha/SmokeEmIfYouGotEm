...
| --- | ---: | ---: | --- |
| `field_linf` | 3.47084 | 0.25 | FAIL |
| `slope_linf` | 0.789758 | 0.25 | FAIL |
| `wet_mismatch_fraction` | 0.263889 | 0.02 | FAIL |
| `probe_linf` | 2.15656 | 0.25 | FAIL |
| `cross_section_linf` | 1.6623 | 0.25 | FAIL |
| `mass_drift_delta` | 0.0474877 | 0.05 | PASS |
| `energy_change_delta` | 0.142814 | 0.25 | PASS |
| `froude_delta` | 1.22692 | 0.5 | FAIL |
| `feature_location_delta` | 3.60555 | 5 | PASS |
| `feature_strength_delta` | 0.769906 | 10 | PASS |

## Notes

- Use transition-aware final upper-edge opposition balance after transition face/source repair; feature forcing remains off.
- Do not promote: upper-edge final velocities and wet-mask/slope improve slightly, but field, slope, wet-mask, probe, cross-section, and Froude parity remain blocked.
