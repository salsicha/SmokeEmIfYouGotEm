...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_upstream_inner_interior_cross_stream_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_upstream_inner_interior_cross_stream_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
...
- Max abs volume-flux delta: `0.409768` m3/s
...
| --- | ---: | --- | --- | --- | --- | ---: | ---: | --- | --- | --- |
| `upper_edge_face` | 6 | `8-9` | `upstream_approach` | `1.15452/-1.44608/-1.66953/-1` | `1.12501/-1.11978/-1.25976/-1` | 0.409768 | -0.029509 | `1/0/0` | `face=True, width=False, bank=False, depth=False` | `geometry_aware_face_state_reconstruction` |
...
| `lower_edge_face` | 2 | `1-2` | `upstream_approach` | `1.01111/1.30241/1.31687/1` | `1.0323/1.53708/1.58673/1` | 0.26986 | 0.0211954 | `0/0/0` | `face=True, width=False, bank=False, depth=False` | `geometry_aware_face_state_reconstruction` |
| `lower_edge_face` | 1 | `1-2` | `upstream_approach` | `0.978339/2.01871/1.97499/1` | `0.988887/1.72784/1.70864/1` | -0.266343 | 0.0105487 | `0/0/0` | `face=True, width=False, bank=False, depth=False` | `geometry_aware_face_state_reconstruction` |
...
| `upper_edge_face` | 4 | `8-9` | `upstream_approach` | `1.11127/-1.10838/-1.23171/-1` | `1.17612/-1.23929/-1.45755/-1` | -0.225841 | 0.0648437 | `0/0/0` | `face=False, width=False, bank=False, depth=False` | `preserve_as_guardrail` |
| `upper_edge_face` | 0 | `8-9` | `upstream_approach` | `1.23942/-1.61985/-2.00767/-1` | `1.18363/-1.54162/-1.82471/-1` | 0.182962 | -0.0557906 | `0/0/0` | `face=False, width=False, bank=False, depth=False` | `preserve_as_guardrail` |
| `upper_edge_face` | 3 | `8-9` | `upstream_approach` | `1.08534/-1.26068/-1.36827/-1` | `1.18774/-1.26992/-1.50833/-1` | -0.140055 | 0.102397 | `0/0/0` | `face=False, width=False, bank=False, depth=False` | `preserve_as_guardrail` |
| `lower_edge_face` | 3 | `1-2` | `upstream_approach` | `1.0627/0.775286/0.823895/1` | `0.99043/0.694334/0.687689/1` | -0.136206 | -0.0722688 | `0/0/0` | `face=False, width=False, bank=False, depth=False` | `preserve_as_guardrail` |
| `lower_edge_face` | 4 | `1-2` | `upstream_approach` | `1.15499/0.20444/0.236126/1` | `0.978171/0.375266/0.367074/1` | 0.130948 | -0.176822 | `0/0/0` | `face=False, width=False, bank=False, depth=False` | `preserve_as_guardrail` |
...
| 7 | `upstream_approach` | `6/3-8/1.25` | `10/1-11/1.25609` | `10/1-11/1.23045` | `0/0/0/-0.025649` | `width=False, bank=False, depth=False` |
| 8 | `upstream_approach` | `6/3-8/1.25` | `7/3-9/1.48607` | `7/3-9/1.4604` | `0/0/0/-0.0256747` | `width=False, bank=False, depth=False` |
| 9 | `upstream_approach` | `6/3-8/1.25` | `7/3-9/1.13466` | `7/3-9/1.20966` | `0/0/0/0.0750023` | `width=False, bank=False, depth=False` |
...
- Start with `upper_edge_face` column 6 rows 8-9; q delta is 0.409768 m3/s, face mean-depth delta is -0.029509 m, wet-width delta is 1 cells, and max bank-row delta is 0 cells.
