...
Face-state width/depth report: `physics/reports/milestone18/constriction_downstream_upper_shear_strong_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_downstream_upper_shear_strong_face_source_audit.json`
...
| --- | ---: | --- | --- | --- | ---: | ---: | --- | --- | ---: | --- |
| `lower_edge_face` | 5 | `1-2` | `1.46296/1` | `0.685275/1` | -0.777682 | -9.85657 | `width=0, bank=0, face_h=-0.283247, column_h=-0.0903836` | `1.64387/1` | 0.180913 | `upstream_edge_width_depth_flux_balance` |
...
| `upper_edge_face` | 5 | `8-9` | `-1.28272/-1` | `-0.972352/-1` | 0.310371 | 3.99201 | `width=0, bank=0, face_h=0.379591, column_h=-0.0903836` | `-3.74297/-1` | -2.46024 | `upstream_edge_width_depth_flux_balance` |
| `upper_edge_face` | 3 | `8-9` | `-1.36827/-1` | `-1.13146/-1` | 0.236812 | 4.4399 | `width=0, bank=0, face_h=0.418404, column_h=-0.0214668` | `-3.98015/-1` | -2.61188 | `upstream_edge_width_depth_flux_balance` |
...
| `upper_edge_face` | 4 | `8-9` | `-1.23171/-1` | `-1.03319/-1` | 0.198528 | 4.13908 | `width=0, bank=0, face_h=0.375582, column_h=-0.061442` | `-3.86997/-1` | -2.63826 | `upstream_edge_width_depth_flux_balance` |
...
| `lower_edge_face` | 4 | `1-2` | `0.236126/1` | `0.877416/1` | 0.641289 | -4.97515 | `width=0, bank=0, face_h=-0.190748, column_h=-0.061442` | `1.96298/1` | 1.72685 | `upstream_edge_y_face_flux_source_balance` |
| `upper_edge_face` | 1 | `8-9` | `-2.29862/-1` | `-1.68926/-1` | 0.609362 | -0.967656 | `width=0, bank=0, face_h=0.15839, column_h=-0.0347563` | `-3.71027/-1` | -1.41165 | `upstream_edge_y_face_flux_source_balance` |
| `upper_edge_face` | 0 | `8-9` | `-2.00767/-1` | `-1.48272/-1` | 0.524955 | -2.30836 | `width=0, bank=0, face_h=-0.0811398, column_h=-0.205262` | `-3.45255/-1` | -1.44487 | `upstream_edge_y_face_flux_source_balance` |
