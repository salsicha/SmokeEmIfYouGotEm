...
- Max field delta: `0.49564`
- Max h/u/v/hu/hv delta: `0.355242` / `0.439552` / `0.481163` / `0.491452` / `0.49564`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `recovery` | `interior` | 46 | 0.09473 / 0.350468 | -0.0544326 / 0.439552 | 0.0217782 / 0.37979 | 0.106069 / 0.491452 | 0.0420234 / 0.49564 | 4.35758 | 0 | 1.98256 |
...
- Final-frame `hv` field remains 1.98x over threshold at `recovery/interior` cell 3,20.
...
- Start with `recovery/interior` cell 3,20; `hv` delta is `0.49564` with reference h `1.22566` m and C++ h `1.35665` m.
