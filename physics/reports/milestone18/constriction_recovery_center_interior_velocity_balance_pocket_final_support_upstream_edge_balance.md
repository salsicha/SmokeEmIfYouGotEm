...
Face-state width/depth report: `physics/reports/milestone18/constriction_recovery_center_interior_velocity_balance_pocket_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_recovery_center_interior_velocity_balance_pocket_final_support_face_source_audit.json`
...
| `lower_edge_face` | 2 | `1-2` | `1.31687/1` | `1.44015/1` | 0.123282 | 0.922333 | `width=0, bank=0, face_h=0.0211954, column_h=0.00123228` | `2.31317/1` | 0.996301 | `upstream_edge_y_face_flux_source_balance` |
...
| `lower_edge_face` | 3 | `1-2` | `0.823895/1` | `0.77769/1` | -0.0462046 | -2.17381 | `width=0, bank=0, face_h=-0.0722688, column_h=-0.0145922` | `2.13312/1` | 1.30922 | `upstream_edge_y_face_flux_source_balance` |
