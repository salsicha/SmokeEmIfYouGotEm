...
- Max field delta: `0.286294`
- Max h/u/v/hu/hv delta: `0.277436` / `0.285781` / `0.285449` / `0.28614` / `0.286294`
...
- Final-frame `hv` field remains 1.15x over threshold at `downstream_constriction/interior` cell 5,14.
...
- Cross-stream shear/momentum mismatch is still active in `downstream_constriction/interior` (max v/hv delta `0.285449`/`0.286294`).

## Next Levers

- Start with `downstream_constriction/interior` cell 5,14; `hv` delta is `-0.286294` with reference h `1.20314` m and C++ h `1.33955` m.
