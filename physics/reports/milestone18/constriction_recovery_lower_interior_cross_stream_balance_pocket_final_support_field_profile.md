...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_recovery_lower_interior_cross_stream_balance_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_recovery_lower_interior_cross_stream_balance_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.336402`
- Max h/u/v/hu/hv delta: `0.309993` / `0.329199` / `0.33579` / `0.336402` / `0.322086`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `recovery` | `interior` | 46 | 0.0953134 / 0.277436 | -0.0762929 / 0.309551 | -0.0158518 / 0.278258 | 0.0806601 / 0.336402 | -0.0115655 / 0.302606 | 4.38441 | 0 | 1.34561 |
...
- Final-frame `hu` field remains 1.35x over threshold at `recovery/interior` cell 7,16.
...
- Start with `recovery/interior` cell 7,16; `hu` delta is `0.336402` with reference h `1.23148` m and C++ h `1.25001` m.
