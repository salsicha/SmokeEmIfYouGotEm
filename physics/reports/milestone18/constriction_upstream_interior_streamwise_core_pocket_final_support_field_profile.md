...
- Max field delta: `0.477009`
- Max h/u/v/hu/hv delta: `0.355242` / `0.439552` / `0.402237` / `0.465123` / `0.477009`
...
- Final-frame `hv` field remains 1.91x over threshold at `recovery/interior` cell 4,22.
...
- Start with `recovery/interior` cell 4,22; `hv` delta is `0.477009` with reference h `1.39882` m and C++ h `1.46604` m.
