...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_upstream_upper_interior_velocity_balance_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_upstream_upper_interior_velocity_balance_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.302606`
- Max h/u/v/hu/hv delta: `0.293742` / `0.291581` / `0.300528` / `0.30155` / `0.302606`
...
- Final-frame `hv` field remains 1.21x over threshold at `recovery/interior` cell 5,16.
...
- Start with `recovery/interior` cell 5,16; `hv` delta is `-0.302606` with reference h `1.25986` m and C++ h `1.42035` m.
