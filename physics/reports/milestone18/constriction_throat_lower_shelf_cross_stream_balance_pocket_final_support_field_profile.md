...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_throat_lower_shelf_cross_stream_balance_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_throat_lower_shelf_cross_stream_balance_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.332812`
- Max h/u/v/hu/hv delta: `0.309993` / `0.329199` / `0.300528` / `0.332812` / `0.322086`
...
- Final-frame `hu` field remains 1.33x over threshold at `constriction_throat/interior` cell 5,10.
...
- Start with `constriction_throat/interior` cell 5,10; `hu` delta is `0.332812` with reference h `1.63184` m and C++ h `1.6666` m.
