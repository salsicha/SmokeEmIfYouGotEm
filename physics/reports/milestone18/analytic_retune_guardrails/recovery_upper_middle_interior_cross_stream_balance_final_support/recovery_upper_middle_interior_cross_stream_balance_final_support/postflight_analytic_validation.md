...
Candidate: `recovery_upper_middle_interior_cross_stream_balance_final_support` (`cpp`)
...
| hydraulic_jump_conjugate_depth | analytic | FAIL | 711 | conjugate_depth_ratio_abs, froude_class_agreement |
