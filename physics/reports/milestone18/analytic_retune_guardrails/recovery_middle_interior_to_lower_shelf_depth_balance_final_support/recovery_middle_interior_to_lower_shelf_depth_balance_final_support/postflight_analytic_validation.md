...
Candidate: `recovery_middle_interior_to_lower_shelf_depth_balance_final_support` (`cpp`)
...
| wet_dry_shoreline | well_balanced | FAIL | 461 | wet_mask_mismatch_count, shoreline_position_abs |
...
| hydraulic_jump_conjugate_depth | analytic | FAIL | 710 | conjugate_depth_ratio_abs, froude_class_agreement |
