...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_downstream_interior_final_acceleration/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_downstream_interior_final_acceleration/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `2.02572`
- Max h/u/v/hu/hv delta: `1.02867` / `2.02572` / `1.65063` / `1.97589` / `1.62455`
...
| `downstream_constriction` | `interior` | 8 | 0.104134 / 0.227097 | -0.678676 / 1.11161 | -0.657185 / 1.29742 | -0.637272 / 1.26897 | -0.798297 / 1.62455 | 0.833071 | 0 | 6.49821 |
...
| `constriction_throat` | `upper_edge` | 2 | 0.533579 / 0.582834 | -0.00211336 / 0.00647273 | 0.435062 / 1.33994 | 1.31475 / 1.51115 | 0.0904897 / 0.264799 | 1.06716 | 0 | 6.04458 |
...
| `upstream_approach` | `interior` | 54 | -0.141482 / 0.400207 | 0.1789 / 0.651067 | -0.118415 / 0.803434 | 0.194019 / 1.27807 | -0.186248 / 1.41792 | -7.64003 | 0 | 5.67168 |
...
| `v` | `upstream_approach` | `upper_shelf` | `11,0` | 0 | 5.5 | -0.228902 | -1.83447 | -1.60557 | 1.60557 | 0.25 | 6.42228 |
...
| `hu` | `recovery` | `interior` | `6,19` | 19 | 0.5 | 3.75007 | 2.23154 | -1.51852 | 1.51852 | 0.25 | 6.07409 |
| `hu` | `constriction_throat` | `upper_edge` | `7,13` | 13 | 1.5 | 0.701957 | 2.2131 | 1.51115 | 1.51115 | 0.25 | 6.04458 |

## Blocked Reasons

- Final-frame `u` field remains 8.10x over threshold at `upstream_approach/lower_shelf` cell 1,7.
- Depth/profile mismatch is still active in `upstream_approach/lower_edge` (max h delta `1.02867` m).
- Streamwise shear/momentum mismatch is still active in `upstream_approach/lower_shelf` (max u/hu delta `2.02572`/`0.966763`).
