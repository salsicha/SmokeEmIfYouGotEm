...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_upstream_near_throat_interior_streamwise_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_upstream_near_throat_interior_streamwise_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.412687`
- Max h/u/v/hu/hv delta: `0.355242` / `0.410862` / `0.402237` / `0.411457` / `0.412687`
...
- Final-frame `hv` field remains 1.65x over threshold at `recovery/lower_edge` cell 2,22.
...
- Start with `recovery/lower_edge` cell 2,22; `hv` delta is `0.412687` with reference h `1.3577` m and C++ h `1.32113` m.
