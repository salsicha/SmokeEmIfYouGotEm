...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_upstream_upper_shelf_velocity_balance_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_upstream_upper_shelf_velocity_balance_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.290944`
- Max h/u/v/hu/hv delta: `0.277436` / `0.285781` / `0.285449` / `0.28614` / `0.290944`
...
- Final-frame `hv` field remains 1.16x over threshold at `recovery/interior` cell 6,21.
...
- Start with `recovery/interior` cell 6,21; `hv` delta is `-0.290944` with reference h `1.40511` m and C++ h `1.46453` m.
