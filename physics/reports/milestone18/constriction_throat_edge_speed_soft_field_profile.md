...
- Max field delta: `2.50502`
- Max h/u/v/hu/hv delta: `1.13532` / `2.43911` / `2.47477` / `2.50502` / `1.6578`
...
| `constriction_throat` | `upper_edge` | 2 | 0.910474 / 0.928171 | 0.134387 / 0.232725 | -0.37471 / 2.08427 | 2.4052 / 2.44529 | -1.0224 / 1.40384 | 1.82095 | 0 | 9.78116 |
...
| `hu` | `constriction_throat` | `upper_edge` | `7,10` | 10 | 1.5 | 0.889107 | 3.3344 | 2.44529 | 2.44529 | 0.25 | 9.78116 |
| `u` | `upstream_approach` | `lower_shelf` | `1,7` | 7 | -4.5 | -0.525053 | 1.91406 | 2.43911 | 2.43911 | 0.25 | 9.75644 |
| `hu` | `constriction_throat` | `upper_edge` | `7,13` | 13 | 1.5 | 0.701957 | 3.06707 | 2.36511 | 2.36511 | 0.25 | 9.46045 |
...
- Final-frame `hu` field remains 10.02x over threshold at `constriction_throat/lower_shelf` cell 3,13.
- Depth/profile mismatch is still active in `recovery/upper_edge` (max h delta `1.13532` m).
- Streamwise shear/momentum mismatch is still active in `constriction_throat/lower_shelf` (max u/hu delta `0.210905`/`2.50502`).
