...
- Max field delta: `0.400549`
- Max h/u/v/hu/hv delta: `0.355242` / `0.389623` / `0.33579` / `0.399788` / `0.400549`
...
- Final-frame `hv` field remains 1.60x over threshold at `upstream_approach/interior` cell 8,1.
...
- Cross-stream shear/momentum mismatch is still active in `upstream_approach/interior` (max v/hv delta `0.259132`/`0.400549`).

## Next Levers

- Start with `upstream_approach/interior` cell 8,1; `hv` delta is `-0.400549` with reference h `1.69577` m and C++ h `1.65524` m.
