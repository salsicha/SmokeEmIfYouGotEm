...
- Max abs lateral volume-flux delta: `0.559621` m3/s
- Max abs flux/source balance delta: `9.18497` m3/s2
...
| --- | ---: | --- | ---: | ---: | ---: | --- | --- | ---: | --- | --- | --- |
| `lower_edge_face` | 5 | `1-2` | 5 | -4 | -2 | `1.24635/1.26151/1.17379/1.46296` | `0.974149/1.45773/0.927308/0.903336` | -0.559621 | `1->1` | `-3.84428/-5.34069/-9.18497` | `2.23848/12.2466` |
...
| `lower_edge_face` | 4 | `1-2` | 4 | -4 | -2 | `1.15499/1.95534/0.20444/0.236126` | `0.978093/2.52878/0.589006/0.576102` | 0.339976 | `1->1` | `-1.55982/-3.47078/-5.0306` | `1.3599/6.70746` |
...
- Start with `lower_edge_face` column 5 rows 1-2; reconstructed q delta is -0.559621 m3/s and balance delta is -9.18497 m3/s2.
...
- Use the exported C++ internal audit at `lower_edge_face` column 5 rows 1-2; post-source q delta is 0.39958 m3/s.
