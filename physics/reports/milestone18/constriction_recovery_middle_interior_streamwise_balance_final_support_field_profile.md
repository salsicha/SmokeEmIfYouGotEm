...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_recovery_middle_interior_streamwise_balance_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_recovery_middle_interior_streamwise_balance_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.263705`
- Max h/u/v/hu/hv delta: `0.263487` / `0.262286` / `0.263705` / `0.250292` / `0.258701`
...
- Final-frame `v` field remains 1.05x over threshold at `upstream_approach/upper_shelf` cell 11,6.
...
- Start with `upstream_approach/upper_shelf` cell 11,6; `v` delta is `-0.263705` with reference h `0.188913` m and C++ h `0.187` m.
