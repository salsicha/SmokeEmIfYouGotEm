...
- Max field delta: `0.562798`
- Max h/u/v/hu/hv delta: `0.466456` / `0.550955` / `0.502471` / `0.55627` / `0.562798`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `recovery` | `interior` | 46 | 0.100852 / 0.376764 | -0.0843054 / 0.550763 | 0.039265 / 0.412192 | 0.0786438 / 0.532979 | 0.0685506 / 0.562798 | 4.6392 | 0 | 2.25119 |
...
- Final-frame `hv` field remains 2.25x over threshold at `recovery/interior` cell 3,22.
...
- Start with `recovery/interior` cell 3,22; `hv` delta is `0.562798` with reference h `1.37071` m and C++ h `1.33024` m.
