...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_downstream_interior_streamwise_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_downstream_interior_streamwise_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `1.37014`
- Max h/u/v/hu/hv delta: `0.944214` / `1.37014` / `1.33994` / `1.33656` / `1.32513`
...
- Final-frame `u` field remains 5.48x over threshold at `recovery/upper_shelf` cell 9,16.
- Depth/profile mismatch is still active in `upstream_approach/lower_edge` (max h delta `0.944214` m).
- Streamwise shear/momentum mismatch is still active in `recovery/upper_shelf` (max u/hu delta `1.37014`/`0.305526`).
