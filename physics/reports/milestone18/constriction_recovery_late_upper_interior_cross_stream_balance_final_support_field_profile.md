...
- Max field delta: `0.279153`
- Max h/u/v/hu/hv delta: `0.270925` / `0.279153` / `0.263705` / `0.278403` / `0.258701`
...
- Final-frame `u` field remains 1.12x over threshold at `recovery/upper_edge` cell 9,21.
...
- Start with `recovery/upper_edge` cell 9,21; `u` delta is `-0.279153` with reference h `0.267068` m and C++ h `0.375` m.
