...
- Max field delta: `0.508163`
- Max h/u/v/hu/hv delta: `0.466456` / `0.502464` / `0.502471` / `0.499837` / `0.508163`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `recovery` | `interior` | 46 | 0.09473 / 0.350468 | -0.0476715 / 0.439552 | 0.0290209 / 0.37979 | 0.116111 / 0.499837 | 0.052841 / 0.508163 | 4.35758 | 0 | 2.03265 |
| `upstream_approach` | `interior` | 54 | -0.0398238 / 0.466456 | 0.0424391 / 0.37006 | -0.0327296 / 0.502471 | 0.0661985 / 0.477967 | -0.0754752 / 0.487838 | -2.15048 | 0 | 2.00988 |
...
| `h` | `upstream_approach` | `interior` | `7,9` | 9 | 1.5 | 1.16676 | 1.63322 | 0.466456 | 0.466456 | 0.25 | 1.86582 |
...
- Final-frame `hv` field remains 2.03x over threshold at `recovery/interior` cell 5,20.
- Depth/profile mismatch is still active in `upstream_approach/interior` (max h delta `0.466456` m).
- Streamwise shear/momentum mismatch is still active in `upstream_approach/upper_shelf` (max u/hu delta `0.502464`/`0.442833`).
- Cross-stream shear/momentum mismatch is still active in `recovery/interior` (max v/hv delta `0.37979`/`0.508163`).

## Next Levers

- Start with `recovery/interior` cell 5,20; `hv` delta is `0.508163` with reference h `1.295` m and C++ h `1.49359` m.
