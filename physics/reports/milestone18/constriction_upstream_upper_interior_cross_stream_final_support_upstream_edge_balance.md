...
Face-state width/depth report: `physics/reports/milestone18/constriction_upstream_upper_interior_cross_stream_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_upstream_upper_interior_cross_stream_final_support_face_source_audit.json`
...
- Target samples: `12`
- Blocked targets: `12`
- Width/depth coupled blockers: `6`
...
| `upper_edge_face` | 6 | `8-9` | `-1.66953/-1` | `-1.37973/-1` | 0.289802 | 0.0350239 | `width=1, bank=0, face_h=0.0772178, column_h=-0.248804` | `-2.10541/-1` | -0.435884 | `upstream_edge_width_depth_mapping` |
...
| `upper_edge_face` | 4 | `8-9` | `-1.23171/-1` | `-1.45765/-1` | -0.225939 | 1.16968 | `width=0, bank=0, face_h=0.0649216, column_h=-0.0629947` | `-2.52124/-1` | -1.28952 | `upstream_edge_y_face_flux_source_balance` |
| `lower_edge_face` | 1 | `1-2` | `1.97499/1` | `1.82805/1` | -0.146936 | 1.8944 | `width=0, bank=0, face_h=0.0930896, column_h=-0.0256694` | `2.9241/1` | 0.949109 | `upstream_edge_y_face_flux_source_balance` |
| `upper_edge_face` | 5 | `8-9` | `-1.28272/-1` | `-1.42237/-1` | -0.139645 | 1.23564 | `width=0, bank=0, face_h=0.0911921, column_h=-0.090556` | `-2.29096/-1` | -1.00823 | `upstream_edge_y_face_flux_source_balance` |
