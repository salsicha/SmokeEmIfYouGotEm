...
| --- | ---: | ---: | --- |
| `field_linf` | 3.74989 | 0.25 | FAIL |
| `slope_linf` | 0.955443 | 0.25 | FAIL |
| `wet_mismatch_fraction` | 0.270833 | 0.02 | FAIL |
| `probe_linf` | 2.15656 | 0.25 | FAIL |
| `cross_section_linf` | 1.6623 | 0.25 | FAIL |
| `mass_drift_delta` | 0.0148899 | 0.05 | PASS |
| `energy_change_delta` | 0.0220351 | 0.25 | PASS |
| `froude_delta` | 1.32035 | 0.5 | FAIL |
| `feature_location_delta` | 3.60555 | 5 | PASS |
| `feature_strength_delta` | 0.785682 | 10 | PASS |

## Notes

- Correct upstream edge face-source row-side convention for lower outside-to-first-wet faces; feature forcing remains off.
- Do not promote unless face/source, face-state width/depth, upstream edge balance, threshold, and Milestone 17 guardrail reports all support the change.
