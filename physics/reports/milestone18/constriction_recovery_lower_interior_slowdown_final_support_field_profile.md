...
- Max field delta: `1.09661`
- Max h/u/v/hu/hv delta: `0.843576` / `1.09267` / `1.05171` / `1.09661` / `1.06264`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `recovery` | `interior` | 46 | 0.0764195 / 0.525296 | -0.101782 / 0.986788 | -0.0015732 / 0.722094 | 0.0207507 / 1.09661 | 0.0130269 / 0.910213 | 3.5153 | 0 | 4.38642 |
...
| `u` | `recovery` | `interior` | `7,19` | 19 | 1.5 | 1.81784 | 0.845027 | -0.972811 | 0.972811 | 0.25 | 3.89124 |
...
- Final-frame `hu` field remains 4.39x over threshold at `recovery/interior` cell 7,19.
- Depth/profile mismatch is still active in `recovery/upper_edge` (max h delta `0.843576` m).
- Streamwise shear/momentum mismatch is still active in `recovery/interior` (max u/hu delta `0.986788`/`1.09661`).
