...
Face-state width/depth report: `physics/reports/milestone18/constriction_upstream_lower_edge_streamwise_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_upstream_lower_edge_streamwise_final_support_face_source_audit.json`
...
| `upper_edge_face` | 4 | `8-9` | `-1.23171/-1` | `-1.45775/-1` | -0.226037 | 1.16992 | `width=0, bank=0, face_h=0.0649216, column_h=-0.0629947` | `-2.52134/-1` | -1.28962 | `upstream_edge_y_face_flux_source_balance` |
| `upper_edge_face` | 3 | `8-9` | `-1.36827/-1` | `-1.53401/-1` | -0.165737 | 1.35096 | `width=0, bank=0, face_h=0.0976764, column_h=-0.0250536` | `-2.899/-1` | -1.53073 | `upstream_edge_y_face_flux_source_balance` |
