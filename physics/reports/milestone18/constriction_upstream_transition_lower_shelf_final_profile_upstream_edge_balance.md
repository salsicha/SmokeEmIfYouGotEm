...
Face-state width/depth report: `physics/reports/milestone18/constriction_upstream_transition_lower_shelf_final_profile_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_upstream_transition_lower_shelf_final_profile_face_source_audit.json`
...
| --- | ---: | --- | --- | --- | ---: | ---: | --- | --- | ---: | --- |
| `lower_edge_face` | 8 | `2-3` | `0.0743101/1` | `0.699744/1` | 0.625434 | 13.9186 | `width=0, bank=0, face_h=0.523887, column_h=-0.000126479` | `0.486288/1` | 0.411978 | `upstream_edge_width_depth_flux_balance` |
...
| `lower_edge_face` | 6 | `1-2` | `0.728892/1` | `0.696725/1` | -0.032167 | 0 | `width=1, bank=0, face_h=-0.440667, column_h=-0.251005` | `1.31478/1` | 0.585892 | `upstream_edge_width_depth_mapping` |
...
| `lower_edge_face` | 2 | `1-2` | `1.31687/1` | `1.87765/1` | 0.560778 | 3.90476 | `width=0, bank=0, face_h=0.0797867, column_h=0.00747109` | `2.90326/1` | 1.58639 | `upstream_edge_y_face_flux_source_balance` |
| `upper_edge_face` | 2 | `8-9` | `-1.91128/-1` | `-2.18419/-1` | -0.272912 | 2.24003 | `width=0, bank=0, face_h=0.160616, column_h=0.00747109` | `-3.98015/-1` | -2.06887 | `upstream_edge_y_face_flux_source_balance` |
