...
- Max field delta: `0.502464`
- Max h/u/v/hu/hv delta: `0.355242` / `0.502464` / `0.481163` / `0.499837` / `0.49564`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `upstream_approach` | `upper_shelf` | 18 | -0.0122372 / 0.139176 | -0.128632 / 0.502464 | -0.0255148 / 0.300528 | -0.0628621 / 0.442833 | 0.00914617 / 0.272483 | -0.22027 | 0.0555556 | 2.00986 |
...
- Final-frame `u` field remains 2.01x over threshold at `upstream_approach/upper_shelf` cell 10,2.
...
- Start with `upstream_approach/upper_shelf` cell 10,2; `u` delta is `-0.502464` with reference h `0.307688` m and C++ h `0.446864` m.
