...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_recovery_terminal_upper_middle_velocity_balance_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_recovery_terminal_upper_middle_velocity_balance_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.342481`
- Max h/u/v/hu/hv delta: `0.340402` / `0.329199` / `0.33579` / `0.342481` / `0.33791`
...
- Final-frame `hu` field remains 1.37x over threshold at `constriction_throat/lower_edge` cell 4,10.
...
- Start with `constriction_throat/lower_edge` cell 4,10; `hu` delta is `0.342481` with reference h `1.68568` m and C++ h `1.66018` m.
