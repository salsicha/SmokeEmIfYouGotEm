...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_recovery_upper_interior_cross_stream_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_recovery_upper_interior_cross_stream_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.820992`
- Max h/u/v/hu/hv delta: `0.655706` / `0.820992` / `0.820926` / `0.76214` / `0.802245`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `recovery` | `upper_edge` | 8 | 0.195636 / 0.655706 | -0.103505 / 0.820992 | 0.201988 / 0.820926 | 0.0316452 / 0.322613 | 0.00973632 / 0.301667 | 1.56509 | 0 | 3.28397 |
...
| `downstream_constriction` | `interior` | 8 | 0.101193 / 0.221196 | -0.408645 / 0.777015 | -0.168146 / 0.464393 | -0.289764 / 0.600363 | -0.151888 / 0.482735 | 0.809547 | 0 | 3.10806 |
...
| `recovery` | `interior` | 46 | 0.086581 / 0.398864 | -0.0963781 / 0.746366 | 0.0384787 / 0.556684 | 0.0509475 / 0.742519 | 0.0625003 / 0.702115 | 3.98273 | 0 | 2.98546 |
...
- Final-frame `u` field remains 3.28x over threshold at `recovery/upper_edge` cell 9,23.
- Depth/profile mismatch is still active in `recovery/upper_edge` (max h delta `0.655706` m).
- Streamwise shear/momentum mismatch is still active in `recovery/upper_edge` (max u/hu delta `0.820992`/`0.322613`).
- Cross-stream shear/momentum mismatch is still active in `recovery/upper_edge` (max v/hv delta `0.820926`/`0.301667`).
