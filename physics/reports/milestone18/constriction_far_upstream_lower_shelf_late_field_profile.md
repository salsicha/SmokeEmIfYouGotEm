...
- Max field delta: `2.57847`
- Max h/u/v/hu/hv delta: `1.13532` / `2.43911` / `2.57847` / `2.5603` / `1.73888`
- Max profile mass delta: `7.02603` m3
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `upstream_approach` | `upper_edge` | 10 | 0.672157 / 1.09496 | -0.741118 / 1.73357 | 1.03649 / 2.57847 | 1.1525 / 1.94862 | -0.333799 / 0.651801 | 6.72157 | 0 | 10.3139 |
...
| `upstream_approach` | `interior` | 54 | -0.130112 / 0.410248 | 0.546978 / 1.21435 | -0.113975 / 0.802149 | 0.812138 / 2.11416 | -0.183578 / 1.40328 | -7.02603 | 0 | 8.45663 |
| `upstream_approach` | `upper_shelf` | 18 | -0.160986 / 0.687619 | -0.511788 / 1.87702 | 0.251287 / 2.04119 | -0.501651 / 1.56166 | 0.193694 / 0.831398 | -2.89776 | 0.0555556 | 8.16476 |
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `v` | `upstream_approach` | `upper_edge` | `9,1` | 1 | 3.5 | -3.72743 | -1.14896 | 2.57847 | 2.57847 | 0.25 | 10.3139 |
...
- Final-frame `v` field remains 10.31x over threshold at `upstream_approach/upper_edge` cell 9,1.
...
- Cross-stream shear/momentum mismatch is still active in `upstream_approach/upper_edge` (max v/hv delta `2.57847`/`0.651801`).
