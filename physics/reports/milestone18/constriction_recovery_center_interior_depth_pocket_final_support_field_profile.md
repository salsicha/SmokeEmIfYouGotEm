...
- Max field delta: `0.549948`
- Max h/u/v/hu/hv delta: `0.466456` / `0.537514` / `0.502471` / `0.544494` / `0.549948`
...
- Final-frame `hv` field remains 2.20x over threshold at `upstream_approach/interior` cell 5,4.
...
- Start with `upstream_approach/interior` cell 5,4; `hv` delta is `-0.549948` with reference h `1.83483` m and C++ h `1.68822` m.
