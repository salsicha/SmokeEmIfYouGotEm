...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_recovery_upper_middle_interior_cross_stream_balance_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_recovery_upper_middle_interior_cross_stream_balance_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.289765`
- Max h/u/v/hu/hv delta: `0.277436` / `0.285781` / `0.285449` / `0.28614` / `0.289765`
...
- Final-frame `hv` field remains 1.16x over threshold at `upstream_approach/interior` cell 4,8.
...
- Cross-stream shear/momentum mismatch is still active in `upstream_approach/interior` (max v/hv delta `0.177068`/`0.289765`).

## Next Levers

- Start with `upstream_approach/interior` cell 4,8; `hv` delta is `-0.289765` with reference h `1.78789` m and C++ h `1.75651` m.
