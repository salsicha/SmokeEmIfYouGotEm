...
Face-state width/depth report: `physics/reports/milestone18/constriction_upstream_upper_interior_cross_stream_slowdown_pocket_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_upstream_upper_interior_cross_stream_slowdown_pocket_final_support_face_source_audit.json`
...
| `upper_edge_face` | 6 | `8-9` | `-1.66953/-1` | `-1.60315/-1` | 0.0663807 | -0.45972 | `width=1, bank=0, face_h=-0.029509, column_h=-0.221841` | `-1.67444/-1` | -0.00491199 | `upstream_edge_width_depth_mapping` |
...
| `upper_edge_face` | 3 | `8-9` | `-1.36827/-1` | `-1.34622/-1` | 0.0220564 | 0.942555 | `width=0, bank=0, face_h=0.102397, column_h=-0.0145922` | `-2.73668/-1` | -1.36841 | `upstream_edge_y_face_flux_source_balance` |
