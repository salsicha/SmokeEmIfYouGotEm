...
Face-state width/depth report: `physics/reports/milestone18/constriction_upstream_mid_interior_cross_stream_pocket_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_upstream_mid_interior_cross_stream_pocket_final_support_face_source_audit.json`
...
| `lower_edge_face` | 4 | `1-2` | `0.236126/1` | `0.391131/1` | 0.155005 | -2.93874 | `width=0, bank=0, face_h=-0.0996471, column_h=-0.0630068` | `2.33626/1` | 2.10013 | `upstream_edge_y_face_flux_source_balance` |
