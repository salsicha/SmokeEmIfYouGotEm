...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_upstream_upper_edge_mid_depth_velocity_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_upstream_upper_edge_mid_depth_velocity_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.402237`
- Max h/u/v/hu/hv delta: `0.355242` / `0.389623` / `0.402237` / `0.399788` / `0.400549`
...
- Final-frame `v` field remains 1.61x over threshold at `upstream_approach/lower_shelf` cell 0,1.
...
- Start with `upstream_approach/lower_shelf` cell 0,1; `v` delta is `0.402237` with reference h `0.258901` m and C++ h `0.295922` m.
