...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_upstream_outer_lower_shelf_depth_balance_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_upstream_outer_lower_shelf_depth_balance_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.322086`
- Max h/u/v/hu/hv delta: `0.309993` / `0.309551` / `0.300528` / `0.314239` / `0.322086`
...
- Final-frame `hv` field remains 1.29x over threshold at `constriction_throat/upper_edge` cell 7,10.
...
- Start with `constriction_throat/upper_edge` cell 7,10; `hv` delta is `-0.322086` with reference h `0.385715` m and C++ h `0.507476` m.
