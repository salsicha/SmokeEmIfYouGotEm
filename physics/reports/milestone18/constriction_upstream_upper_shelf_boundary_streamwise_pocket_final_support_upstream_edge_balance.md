...
Face-state width/depth report: `physics/reports/milestone18/constriction_upstream_upper_shelf_boundary_streamwise_pocket_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_upstream_upper_shelf_boundary_streamwise_pocket_final_support_face_source_audit.json`
...
- Target samples: `12`
- Blocked targets: `12`
- Width/depth coupled blockers: `3`
...
| `lower_edge_face` | 4 | `1-2` | `0.236126/1` | `0.367074/1` | 0.130948 | -5.2299 | `width=0, bank=0, face_h=-0.176822, column_h=-0.0630068` | `1.73663/1` | 1.5005 | `upstream_edge_y_face_flux_source_balance` |
...
- Start with `upper_edge_face` column 6 rows 8-9; q delta is 0.409768 m3/s, balance delta is -1.33357 m3/s2, native post-source delta is 0.221349 m3/s, wet-width delta is 1 cells, and bank-row delta is 0 cells.
