...
- Max field delta: `2.51266`
- Max h/u/v/hu/hv delta: `1.13532` / `2.43911` / `2.47477` / `2.51266` / `1.6578`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `constriction_throat` | `upper_edge` | 2 | 0.910474 / 0.928171 | 0.185661 / 0.283999 | -0.37471 / 2.08427 | 2.46869 / 2.51266 | -1.0224 / 1.40384 | 1.82095 | 0 | 10.0506 |
...
| `downstream_constriction` | `upper_edge` | 2 | 0.130179 / 0.163937 | 1.59942 / 1.89998 | -0.78832 / 1.01179 | 2.09364 / 2.50453 | -0.990018 / 1.26892 | 0.260358 | 0 | 10.0181 |
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `hu` | `constriction_throat` | `upper_edge` | `7,10` | 10 | 1.5 | 0.889107 | 3.40177 | 2.51266 | 2.51266 | 0.25 | 10.0506 |
| `hu` | `constriction_throat` | `lower_shelf` | `3,13` | 13 | -2.5 | 0.701648 | 3.20667 | 2.50502 | 2.50502 | 0.25 | 10.0201 |
| `hu` | `downstream_constriction` | `upper_edge` | `8,14` | 14 | 2.5 | -0.185349 | 2.31918 | 2.50453 | 2.50453 | 0.25 | 10.0181 |
...
| `hu` | `constriction_throat` | `upper_edge` | `7,13` | 13 | 1.5 | 0.701957 | 3.12668 | 2.42472 | 2.42472 | 0.25 | 9.69888 |
...
- Final-frame `hu` field remains 10.05x over threshold at `constriction_throat/upper_edge` cell 7,10.
- Depth/profile mismatch is still active in `recovery/upper_edge` (max h delta `1.13532` m).
- Streamwise shear/momentum mismatch is still active in `constriction_throat/upper_edge` (max u/hu delta `0.283999`/`2.51266`).
