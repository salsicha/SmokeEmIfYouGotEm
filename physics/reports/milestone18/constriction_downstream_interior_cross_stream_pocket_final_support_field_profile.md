...
- Max field delta: `0.526308`
- Max h/u/v/hu/hv delta: `0.466456` / `0.52177` / `0.502471` / `0.526308` / `0.508163`
...
- Final-frame `hu` field remains 2.11x over threshold at `upstream_approach/interior` cell 6,2.
...
- Start with `upstream_approach/interior` cell 6,2; `hu` delta is `0.526308` with reference h `1.78974` m and C++ h `1.74488` m.
