...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_upstream_boundary_lower_interior_cross_stream_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_upstream_boundary_lower_interior_cross_stream_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.383335`
- Max h/u/v/hu/hv delta: `0.355242` / `0.353905` / `0.33579` / `0.383335` / `0.37973`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `upstream_approach` | `interior` | 54 | -0.0472677 / 0.263487 | 0.0274295 / 0.254233 | -0.023475 / 0.220581 | 0.0271869 / 0.383335 | -0.0478692 / 0.37965 | -2.55245 | 0 | 1.53334 |
...
- Final-frame `hu` field remains 1.53x over threshold at `upstream_approach/interior` cell 8,3.
...
- Cross-stream shear/momentum mismatch is still active in `constriction_throat/interior` (max v/hv delta `0.247685`/`0.37973`).

## Next Levers

- Start with `upstream_approach/interior` cell 8,3; `hu` delta is `-0.383335` with reference h `1.78683` m and C++ h `1.83213` m.
