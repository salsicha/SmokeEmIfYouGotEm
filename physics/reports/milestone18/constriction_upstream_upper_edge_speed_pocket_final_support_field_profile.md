...
- Max field delta: `0.668858`
- Max h/u/v/hu/hv delta: `0.655706` / `0.654883` / `0.651338` / `0.663757` / `0.668858`
...
| `downstream_constriction` | `interior` | 8 | 0.101193 / 0.221196 | -0.106349 / 0.4256 | -0.15277 / 0.463802 | 0.111641 / 0.663757 | -0.131588 / 0.475973 | 0.809547 | 0 | 2.65503 |
...
| `upstream_approach` | `upper_shelf` | 18 | -0.00566374 / 0.139176 | -0.167475 / 0.632868 | 0.00736004 / 0.559386 | -0.0634789 / 0.442833 | 0.00976301 / 0.272495 | -0.101947 | 0.0555556 | 2.53147 |
...
| `upstream_approach` | `upper_edge` | 10 | 0.0486362 / 0.382043 | -0.238731 / 0.609377 | 0.0989524 / 0.611694 | 0.0901916 / 0.452691 | -0.18569 / 0.621231 | 0.486362 | 0 | 2.48492 |
...
- Final-frame `hv` field remains 2.68x over threshold at `constriction_throat/interior` cell 6,10.
- Depth/profile mismatch is still active in `recovery/upper_edge` (max h delta `0.655706` m).
- Streamwise shear/momentum mismatch is still active in `downstream_constriction/interior` (max u/hu delta `0.4256`/`0.663757`).
- Cross-stream shear/momentum mismatch is still active in `constriction_throat/interior` (max v/hv delta `0.490964`/`0.668858`).

## Next Levers

- Start with `constriction_throat/interior` cell 6,10; `hv` delta is `0.668858` with reference h `1.48691` m and C++ h `1.47041` m.
