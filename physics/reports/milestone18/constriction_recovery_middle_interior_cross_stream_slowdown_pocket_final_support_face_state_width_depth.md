...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_recovery_middle_interior_cross_stream_slowdown_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_recovery_middle_interior_cross_stream_slowdown_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
...
| `upper_edge_face` | 3 | `8-9` | `upstream_approach` | `1.08534/-1.26068/-1.36827/-1` | `1.18774/-1.25987/-1.4964/-1` | -0.128122 | 0.102397 | `0/0/0` | `face=False, width=False, bank=False, depth=False` | `preserve_as_guardrail` |
| `upper_edge_face` | 1 | `8-9` | `upstream_approach` | `1.03834/-2.21375/-2.29862/-1` | `1.01824/-2.34941/-2.39227/-1` | -0.0936483 | -0.020093 | `0/0/0` | `face=False, width=False, bank=False, depth=False` | `preserve_as_guardrail` |
...
| `upper_edge_face` | 6 | `8-9` | `upstream_approach` | `1.15452/-1.44608/-1.66953/-1` | `1.12501/-1.42505/-1.60319/-1` | 0.0663386 | -0.029509 | `1/0/0` | `face=False, width=False, bank=False, depth=False` | `preserve_as_guardrail` |
| `upper_edge_face` | 0 | `8-9` | `upstream_approach` | `1.23942/-1.61985/-2.00767/-1` | `1.23917/-1.6597/-2.05664/-1` | -0.0489701 | -0.000253219 | `0/0/0` | `face=False, width=False, bank=False, depth=False` | `preserve_as_guardrail` |
| `lower_edge_face` | 3 | `1-2` | `upstream_approach` | `1.0627/0.775286/0.823895/1` | `0.99043/0.785217/0.777702/1` | -0.0461928 | -0.0722688 | `0/0/0` | `face=False, width=False, bank=False, depth=False` | `preserve_as_guardrail` |
