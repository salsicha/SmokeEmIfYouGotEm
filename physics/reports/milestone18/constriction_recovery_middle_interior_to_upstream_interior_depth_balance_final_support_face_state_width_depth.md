...
- Max abs face mean-depth delta: `0.163673` m
...
| `lower_edge_face` | 5 | `1-2` | `upstream_approach` | `1.24635/1.17379/1.46296/1` | `1.08268/1.07922/1.16845/1` | -0.29451 | -0.163673 | `0/0/0` | `face=True, width=False, bank=False, depth=False` | `geometry_aware_face_state_reconstruction` |
...
| 5 | `upstream_approach` | `8/2-9/1.25` | `11/1-11/1.30334` | `11/1-11/1.21401` | `0/0/0/-0.0893286` | `width=False, bank=False, depth=False` |
| 6 | `upstream_approach` | `8/2-9/1.25` | `10/1-11/1.45507` | `11/1-11/1.29462` | `1/0/0/-0.160457` | `width=False, bank=False, depth=False` |
