...
Face-state width/depth report: `physics/reports/milestone18/constriction_recovery_middle_to_upstream_lower_shelf_depth_balance_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_recovery_middle_to_upstream_lower_shelf_depth_balance_final_support_face_source_audit.json`
...
| --- | ---: | --- | --- | --- | ---: | ---: | --- | --- | ---: | --- |
| `lower_edge_face` | 6 | `1-2` | `0.728892/1` | `0.696792/1` | -0.0320997 | -2.60446 | `width=1, bank=0, face_h=-0.0788217, column_h=-0.181287` | `2.84294/1` | 2.11405 | `upstream_edge_width_depth_flux_balance` |
| `upper_edge_face` | 6 | `8-9` | `-1.66953/-1` | `-1.63372/-1` | 0.0358146 | -0.371775 | `width=1, bank=0, face_h=-0.029509, column_h=-0.181287` | `-1.71542/-1` | -0.0458902 | `upstream_edge_width_depth_mapping` |
...
- Start with `lower_edge_face` column 6 rows 1-2; q delta is -0.0320997 m3/s, balance delta is -2.60446 m3/s2, native post-source delta is 2.11405 m3/s, wet-width delta is 1 cells, and bank-row delta is 0 cells.
