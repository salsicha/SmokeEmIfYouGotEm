...
Face-state width/depth report: `physics/reports/milestone18/constriction_upstream_lower_middle_interior_streamwise_balance_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_upstream_lower_middle_interior_streamwise_balance_final_support_face_source_audit.json`
...
| `upper_edge_face` | 6 | `8-9` | `-1.66953/-1` | `-1.63372/-1` | 0.0358146 | -0.371775 | `width=1, bank=0, face_h=-0.029509, column_h=-0.199341` | `-1.71542/-1` | -0.0458902 | `upstream_edge_width_depth_mapping` |
