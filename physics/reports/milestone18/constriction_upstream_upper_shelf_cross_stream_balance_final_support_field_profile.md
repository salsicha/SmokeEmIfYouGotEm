...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_upstream_upper_shelf_cross_stream_balance_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_upstream_upper_shelf_cross_stream_balance_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.299246`
- Max h/u/v/hu/hv delta: `0.293742` / `0.291581` / `0.294316` / `0.299246` / `0.294638`
...
- Final-frame `hu` field remains 1.20x over threshold at `upstream_approach/interior` cell 6,8.
...
- Cross-stream shear/momentum mismatch is still active in `upstream_approach/lower_shelf` (max v/hv delta `0.221148`/`0.294638`).

## Next Levers

- Start with `upstream_approach/interior` cell 6,8; `hu` delta is `0.299246` with reference h `1.75202` m and C++ h `1.76053` m.
