...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_recovery_lower_interior_streamwise_balance_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_recovery_lower_interior_streamwise_balance_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.285781`
- Max h/u/v/hu/hv delta: `0.277436` / `0.285781` / `0.263705` / `0.278403` / `0.284311`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `recovery` | `interior` | 46 | 0.0856157 / 0.277436 | -0.0757706 / 0.285781 | -0.00539434 / 0.191931 | 0.0547488 / 0.274105 | 0.00219097 / 0.280291 | 3.93832 | 0 | 1.14312 |
...
- Final-frame `u` field remains 1.14x over threshold at `recovery/interior` cell 8,23.
- Depth/profile mismatch is still active in `recovery/interior` (max h delta `0.277436` m).
- Streamwise shear/momentum mismatch is still active in `recovery/interior` (max u/hu delta `0.285781`/`0.274105`).
- Cross-stream shear/momentum mismatch is still active in `upstream_approach/interior` (max v/hv delta `0.177068`/`0.284311`).

## Next Levers

- Start with `recovery/interior` cell 8,23; `u` delta is `-0.285781` with reference h `1.45123` m and C++ h `1.72867` m.
