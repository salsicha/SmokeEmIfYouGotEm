...
- Max field delta: `0.487838`
- Max h/u/v/hu/hv delta: `0.355242` / `0.439552` / `0.481163` / `0.477967` / `0.487838`
...
- Final-frame `hv` field remains 1.95x over threshold at `upstream_approach/interior` cell 3,1.
...
- Start with `upstream_approach/interior` cell 3,1; `hv` delta is `-0.487838` with reference h `1.75416` m and C++ h `1.74206` m.
