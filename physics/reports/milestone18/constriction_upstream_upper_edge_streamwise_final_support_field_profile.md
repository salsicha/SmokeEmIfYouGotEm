...
- Max field delta: `1.23756`
- Max h/u/v/hu/hv delta: `0.944214` / `1.23756` / `1.14887` / `1.23716` / `1.14337`
...
| `upstream_approach` | `upper_shelf` | 18 | -0.0520344 / 0.484683 | -0.247112 / 0.798123 | 0.0800185 / 1.14887 | -0.169273 / 1.19873 | 0.061095 / 0.855263 | -0.936619 | 0.0555556 | 4.7949 |
...
| `upstream_approach` | `upper_edge` | 10 | 0.0829265 / 0.43989 | -0.386151 / 0.739823 | 0.095275 / 0.82526 | 0.0760815 / 0.267909 | -0.275585 / 1.09012 | 0.829265 | 0 | 4.36047 |
...
| `upstream_approach` | `interior` | 54 | -0.0490701 / 0.52657 | 0.204637 / 0.61841 | -0.0817135 / 0.487551 | 0.329591 / 1.04713 | -0.161431 / 0.614543 | -2.64978 | 0 | 4.18853 |
...
| `hv` | `upstream_approach` | `upper_edge` | `8,8` | 8 | 2.5 | -1.17242 | -2.26254 | -1.09012 | 1.09012 | 0.25 | 4.36047 |
| `u` | `upstream_approach` | `lower_shelf` | `1,1` | 1 | -4.5 | 3.85418 | 2.76452 | -1.08966 | 1.08966 | 0.25 | 4.35862 |
| `hu` | `recovery` | `interior` | `7,20` | 20 | 1.5 | 2.39188 | 1.30405 | -1.08783 | 1.08783 | 0.25 | 4.35133 |
| `u` | `recovery` | `lower_shelf` | `1,21` | 21 | -4.5 | 0.0702233 | 1.1568 | 1.08658 | 1.08658 | 0.25 | 4.3463 |
| `hu` | `upstream_approach` | `lower_edge` | `2,5` | 5 | -3.5 | 1.31208 | 2.39389 | 1.08181 | 1.08181 | 0.25 | 4.32726 |
| `u` | `recovery` | `lower_shelf` | `1,20` | 20 | -4.5 | -0.0551087 | 1.0108 | 1.06591 | 1.06591 | 0.25 | 4.26365 |

## Blocked Reasons

- Final-frame `u` field remains 4.95x over threshold at `upstream_approach/lower_edge` cell 3,9.
- Depth/profile mismatch is still active in `upstream_approach/lower_edge` (max h delta `0.944214` m).
- Streamwise shear/momentum mismatch is still active in `upstream_approach/lower_edge` (max u/hu delta `1.23756`/`1.08181`).
- Cross-stream shear/momentum mismatch is still active in `upstream_approach/upper_shelf` (max v/hv delta `1.14887`/`0.855263`).
