...
- Max field delta: `2.77514`
- Max h/u/v/hu/hv delta: `1.13531` / `2.70432` / `2.48586` / `2.77514` / `1.73887`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `recovery` | `lower_edge` | 6 | 0.0505631 / 0.229415 | 1.24397 / 2.33176 | 0.0324371 / 0.227827 | 1.61601 / 2.77514 | 0.0520882 / 0.308748 | 0.303378 | 0 | 11.1005 |
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `hu` | `recovery` | `lower_edge` | `2,18` | 18 | -3.5 | -0.362344 | 2.41279 | 2.77514 | 2.77514 | 0.25 | 11.1005 |
...
| `u` | `recovery` | `lower_edge` | `2,18` | 18 | -3.5 | -0.306137 | 2.02562 | 2.33176 | 2.33176 | 0.25 | 9.32703 |
...
- Final-frame `hu` field remains 11.10x over threshold at `recovery/lower_edge` cell 2,18.
- Depth/profile mismatch is still active in `recovery/upper_edge` (max h delta `1.13531` m).
- Streamwise shear/momentum mismatch is still active in `recovery/lower_edge` (max u/hu delta `2.33176`/`2.77514`).
