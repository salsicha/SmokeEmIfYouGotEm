...
Face-state width/depth report: `physics/reports/milestone18/constriction_upstream_lower_shelf_cross_stream_depth_pocket_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_upstream_lower_shelf_cross_stream_depth_pocket_final_support_face_source_audit.json`
...
- Max abs balance delta: `9.76516` m3/s2
...
| --- | ---: | --- | --- | --- | ---: | ---: | --- | --- | ---: | --- |
| `lower_edge_face` | 5 | `1-2` | `1.46296/1` | `0.756666/1` | -0.706291 | -9.4349 | `width=0, bank=0, face_h=-0.272206, column_h=-0.0905715` | `1.67509/1` | 0.212136 | `upstream_edge_width_depth_flux_balance` |
...
| `lower_edge_face` | 6 | `1-2` | `0.728892/1` | `0.484066/1` | -0.244826 | -9.76516 | `width=1, bank=0, face_h=-0.301868, column_h=-0.247442` | `2.20492/1` | 1.47603 | `upstream_edge_width_depth_flux_balance` |
| `lower_edge_face` | 4 | `1-2` | `0.236126/1` | `0.575988/1` | 0.339862 | -5.03073 | `width=0, bank=0, face_h=-0.1769, column_h=-0.0630068` | `2.00103/1` | 1.7649 | `upstream_edge_y_face_flux_source_balance` |
