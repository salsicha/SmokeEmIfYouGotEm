...
- Max field delta: `0.491452`
- Max h/u/v/hu/hv delta: `0.355242` / `0.439552` / `0.481163` / `0.491452` / `0.487838`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `recovery` | `interior` | 46 | 0.09473 / 0.350468 | -0.0544326 / 0.439552 | 0.0135077 / 0.339079 | 0.106069 / 0.491452 | 0.0308032 / 0.477009 | 4.35758 | 0 | 1.96581 |
...
- Final-frame `hu` field remains 1.97x over threshold at `recovery/interior` cell 5,19.
- Depth/profile mismatch is still active in `recovery/upper_edge` (max h delta `0.355242` m).
- Streamwise shear/momentum mismatch is still active in `recovery/interior` (max u/hu delta `0.439552`/`0.491452`).
- Cross-stream shear/momentum mismatch is still active in `upstream_approach/interior` (max v/hv delta `0.27877`/`0.487838`).

## Next Levers

- Start with `recovery/interior` cell 5,19; `hu` delta is `0.491452` with reference h `1.22837` m and C++ h `1.57884` m.
