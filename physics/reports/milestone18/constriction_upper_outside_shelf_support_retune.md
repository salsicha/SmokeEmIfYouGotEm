...
| --- | ---: | ---: | --- |
| `field_linf` | 3.4672 | 0.25 | FAIL |
| `slope_linf` | 0.787765 | 0.25 | FAIL |
| `wet_mismatch_fraction` | 0.263889 | 0.02 | FAIL |
| `probe_linf` | 2.15656 | 0.25 | FAIL |
| `cross_section_linf` | 1.6623 | 0.25 | FAIL |
| `mass_drift_delta` | 0.0448569 | 0.05 | PASS |
| `energy_change_delta` | 0.133571 | 0.25 | PASS |
| `froude_delta` | 0.447012 | 0.5 | PASS |
| `feature_location_delta` | 3.60555 | 5 | PASS |
| `feature_strength_delta` | 0.777707 | 10 | PASS |

## Notes

- Use bounded upper outside shelf support after the upper-edge final-balance attempt; feature forcing remains off.
- Do not promote: Froude returns inside threshold and conservation stays visible, but field, slope, wet-mask, probe, and cross-section parity remain blocked.
