...
- Max field delta: `0.502471`
- Max h/u/v/hu/hv delta: `0.466456` / `0.502464` / `0.502471` / `0.499837` / `0.49564`
...
- Final-frame `v` field remains 2.01x over threshold at `upstream_approach/interior` cell 7,9.
...
- Cross-stream shear/momentum mismatch is still active in `upstream_approach/interior` (max v/hv delta `0.502471`/`0.487838`).

## Next Levers

- Start with `upstream_approach/interior` cell 7,9; `v` delta is `0.502471` with reference h `1.16676` m and C++ h `1.63322` m.
