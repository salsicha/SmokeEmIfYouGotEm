...
Dual solver manifest: `physics/outputs/m18cmp/c_constrict_upstream_mid_upper_interior_cross_stream_pocket_final_support/finite_volume_roe/dual_solver_manifest.json`
Scenario package: `physics/outputs/m18cmp/c_constrict_upstream_mid_upper_interior_cross_stream_pocket_final_support/finite_volume_roe/scenario/constriction_seed_16`
Wet-depth threshold: `0.15` m
Velocity depth floor: `0.15` m

## Summary

- Max field delta: `0.465123`
- Max h/u/v/hu/hv delta: `0.355242` / `0.439552` / `0.402237` / `0.465123` / `0.440334`
...
| --- | --- | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: |
| `upstream_approach` | `interior` | 54 | -0.0472677 / 0.263487 | 0.0304297 / 0.26848 | -0.0342043 / 0.259132 | 0.0336465 / 0.465123 | -0.0662284 / 0.400549 | -2.55245 | 0 | 1.86049 |
...
- Final-frame `hu` field remains 1.86x over threshold at `upstream_approach/interior` cell 6,4.
...
- Cross-stream shear/momentum mismatch is still active in `constriction_throat/lower_edge` (max v/hv delta `0.286263`/`0.440334`).

## Next Levers

- Start with `upstream_approach/interior` cell 6,4; `hu` delta is `0.465123` with reference h `1.818` m and C++ h `1.83202` m.
