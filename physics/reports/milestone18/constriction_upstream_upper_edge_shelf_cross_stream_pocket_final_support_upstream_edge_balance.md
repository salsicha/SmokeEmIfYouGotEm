...
Face-state width/depth report: `physics/reports/milestone18/constriction_upstream_upper_edge_shelf_cross_stream_pocket_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_upstream_upper_edge_shelf_cross_stream_pocket_final_support_face_source_audit.json`
...
| `lower_edge_face` | 3 | `1-2` | `0.823895/1` | `0.930047/1` | 0.106152 | -1.91111 | `width=0, bank=0, face_h=-0.0722688, column_h=-0.024794` | `2.30249/1` | 1.4786 | `upstream_edge_y_face_flux_source_balance` |
| `lower_edge_face` | 8 | `2-3` | `0.0743101/1` | `0.412073/1` | 0.337763 | 0.617635 | `width=0, bank=0, face_h=0.00618442, column_h=-0.075691` | `1.59458/1` | 1.52027 | `geometry_aware_face_state_reconstruction` |
