...
Face-state width/depth report: `physics/reports/milestone18/constriction_recovery_middle_interior_cross_stream_slowdown_pocket_final_support_face_state_width_depth.json`
Face/source audit report: `physics/reports/milestone18/constriction_recovery_middle_interior_cross_stream_slowdown_pocket_final_support_face_source_audit.json`
...
| `upper_edge_face` | 3 | `8-9` | `-1.36827/-1` | `-1.4964/-1` | -0.128122 | 1.30198 | `width=0, bank=0, face_h=0.102397, column_h=-0.024794` | `-2.88527/-1` | -1.51699 | `upstream_edge_y_face_flux_source_balance` |
...
| `lower_edge_face` | 9 | `2-3` | `0.0615163/1` | `0.389537/1` | 0.328021 | 0.630117 | `width=0, bank=0, face_h=0.00849284, column_h=0.0750023` | `1.39895/1` | 1.33743 | `geometry_aware_face_state_reconstruction` |
