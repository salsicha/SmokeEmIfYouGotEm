...
| --- | ---: | --- | ---: | ---: | ---: | --- | --- | ---: | --- | --- | --- |
| `lower_edge_face` | 5 | `1-2` | 5 | -4 | -2 | `1.24635/1.26151/1.17379/1.46296` | `0.97406/1.82047/0.777042/0.756886` | -0.706071 | `1->1` | `-4.09467/-5.34242/-9.43709` | `2.82429/12.5828` |
| `upper_edge_face` | 8 | `7-8` | 8 | 2 | 0 | `1.85053/0.89686/-0.760508/-1.40735` | `1.64/1.31453/-1.18693/-1.94656` | -0.539216 | `-1->-1` | `-2.36445/0/-2.36445` | `2.15687/3.1526` |
| `lower_edge_face` | 2 | `1-2` | 2 | -4 | -2 | `1.01111/2.71386/1.30241/1.31687` | `1.09119/2.29466/1.52205/1.66085` | 0.343979 | `1->1` | `1.63861/1.57125/3.20986` | `1.37592/4.27982` |
...
| `upper_edge_face` | 9 | `7-8` | 9 | 2 | 0 | `0.983374/0.990442/-1.39145/-1.36832` | `1.40777/1.09936/-1.18446/-1.66744` | -0.299123 | `-1->-1` | `5.04859/0/5.04859` | `1.19649/6.73145` |
| `upper_edge_face` | 6 | `8-9` | 6 | 3 | 0 | `1.15452/2.04305/-1.44608/-1.66953` | `1.23286/1.77274/-1.11999/-1.3808` | 0.288735 | `-1->-1` | `0.0496024/0/0.0496024` | `1.15494/0.0661365` |
| `upper_edge_face` | 4 | `8-9` | 4 | 3 | 0 | `1.11127/2.46802/-1.10838/-1.23171` | `1.17616/2.05185/-1.23929/-1.4576` | -0.225889 | `-1->-1` | `1.16916/0/1.16916` | `0.903555/1.55888` |
| `lower_edge_face` | 1 | `1-2` | 1 | -4 | -2 | `0.978339/2.7455/2.01871/1.97499` | `1.07143/2.13245/1.70618/1.82806` | -0.14693 | `1->1` | `0.0680228/1.82647/1.89449` | `0.58772/2.52598` |
| `upper_edge_face` | 5 | `8-9` | 5 | 3 | 0 | `1.10988/2.4002/-1.15573/-1.28272` | `1.20104/2.05561/-1.18424/-1.42232` | -0.139596 | `-1->-1` | `1.23512/0/1.23512` | `0.558385/1.64682` |
| `upper_edge_face` | 3 | `8-9` | 3 | 3 | 0 | `1.08534/2.51154/-1.26068/-1.36827` | `1.183/2.05123/-1.27461/-1.50786` | -0.139589 | `-1->-1` | `1.28353/0/1.28353` | `0.558357/1.71137` |
...
| `upper_outer_face` | 7 | `8-9` | `-1.31978/-1` | 1.46901 | `1.46899/1` | 2.78877 | `False` | `False` | `True` | `True` | `-13.1806/-3.93234` |
| `upper_edge_face` | 23 | `8-9` | `-0.895987/-1` | 1.74542 | `1.74542/1` | 2.64141 | `False` | `False` | `False` | `False` | `-0/-2.75906` |
| `lower_inner_source_face` | 14 | `3-4` | `1.15525/1` | -1.39303 | `-1.39303/-1` | -2.54828 | `False` | `False` | `False` | `False` | `0.04062/-0` |
| `lower_inner_source_face` | 15 | `3-4` | `1.15902/1` | -1.31212 | `-1.31212/-1` | -2.47114 | `False` | `False` | `False` | `False` | `0.04062/-0` |
| `upper_edge_face` | 20 | `8-9` | `-0.521241/-1` | 1.94936 | `1.94936/1` | 2.47061 | `False` | `False` | `False` | `False` | `-0/-2.75906` |
| `upper_edge_face` | 22 | `8-9` | `-0.717076/-1` | 1.67951 | `1.67951/1` | 2.39659 | `False` | `False` | `False` | `False` | `-0/-2.75906` |
| `lower_inner_source_face` | 16 | `3-4` | `0.712711/1` | -1.57036 | `-1.57036/-1` | -2.28307 | `False` | `False` | `False` | `False` | `1.02394/-0` |
| `upper_edge_face` | 21 | `8-9` | `-0.57985/-1` | 1.68212 | `1.68212/1` | 2.26197 | `False` | `False` | `False` | `False` | `-0/-2.75906` |
...
| `lower_edge_face` | 10 | `3-4` | `0.126093/1` | -1.69476 | `-1.69476/-1` | -1.82085 | `False` | `False` | `False` | `False` | `4.59844/12.2136` |
