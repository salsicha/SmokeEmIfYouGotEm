...
- Max field delta: `0.468124`
- Max h/u/v/hu/hv delta: `0.355242` / `0.439552` / `0.402237` / `0.465123` / `0.468124`
...
- Final-frame `hv` field remains 1.87x over threshold at `upstream_approach/lower_edge` cell 2,2.
...
- Cross-stream shear/momentum mismatch is still active in `upstream_approach/lower_edge` (max v/hv delta `0.283437`/`0.468124`).

## Next Levers

- Start with `upstream_approach/lower_edge` cell 2,2; `hv` delta is `0.468124` with reference h `1.72272` m and C++ h `1.675` m.
