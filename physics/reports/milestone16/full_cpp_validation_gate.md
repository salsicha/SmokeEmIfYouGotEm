...
| GeoClaw/C++ Threshold Comparisons | BLOCKED | 38 | 2 | 40 | `reports/milestone16/geoclaw_cpp_comparisons.json` |
| Geometry-Specific Validation | PASS | 6 | 0 | 6 | `reports/milestone16/geometry_validation.json` |
| Raft Coupling Validation | BLOCKED | 22 | 28 | 50 | `reports/milestone16/raft_coupling_validation.json` |
| Runtime Profile And Determinism | PASS | 114 | 0 | 114 | `reports/milestone16/runtime_profile.json` |
| Regression Promotion | PASS | 68 | 0 | 68 | `reports/milestone16/regression_promotion_manifest.json` |
