...
| GeoClaw/C++ Threshold Comparisons | BLOCKED | 16 | 24 | 40 | `reports/milestone16/geoclaw_cpp_comparisons.json` |
...
| Runtime Profile And Determinism | PASS | 48 | 0 | 48 | `reports/milestone16/runtime_profile.json` |
| Regression Promotion | PASS | 39 | 0 | 39 | `reports/milestone16/regression_promotion_manifest.json` |
