...
| GeoClaw/C++ Threshold Comparisons | BLOCKED | 10 | 30 | 40 | `reports/milestone16/geoclaw_cpp_comparisons.json` |
...
| Runtime Profile And Determinism | PASS | 30 | 0 | 30 | `reports/milestone16/runtime_profile.json` |
| Regression Promotion | PASS | 33 | 0 | 33 | `reports/milestone16/regression_promotion_manifest.json` |
...
- bed_step: GeoClaw/C++ threshold comparison failed (slope_linf)
